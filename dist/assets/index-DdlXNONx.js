(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class B{updateFn;renderFn;lastTime=0;accumulator=0;fixedDeltaTime=1/60;animationFrameId=null;isRunning=!1;fps=0;frameCount=0;fpsTime=0;constructor(t,e){this.updateFn=t,this.renderFn=e}start(){this.isRunning||(this.isRunning=!0,this.lastTime=performance.now(),this.fpsTime=this.lastTime,this.frameCount=0,this.animationFrameId=requestAnimationFrame(this.tick.bind(this)))}stop(){this.isRunning&&(this.isRunning=!1,this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null))}tick(t){if(!this.isRunning)return;const e=Math.min((t-this.lastTime)/1e3,.1);for(this.lastTime=t,this.frameCount++,t-this.fpsTime>=1e3&&(this.fps=this.frameCount,this.frameCount=0,this.fpsTime=t),this.accumulator+=e;this.accumulator>=this.fixedDeltaTime;)this.updateFn(this.fixedDeltaTime),this.accumulator-=this.fixedDeltaTime;const i=this.accumulator/this.fixedDeltaTime;this.renderFn(i),this.animationFrameId=requestAnimationFrame(this.tick.bind(this))}}class E{state={forward:!1,backward:!1,left:!1,right:!1,run:!1,jump:!1,fire:!1,altFire:!1,reload:!1};mouseDelta={x:0,y:0};isPointerLocked=!1;sensitivity=.005;setSensitivity(t){this.sensitivity=Math.max(.001,Math.min(.015,t))}invertX=!0;invertY=!0;canvas;onPointerLockChange;constructor(t){this.canvas=t,this.setupListeners()}setupListeners(){document.addEventListener("keydown",this.handleKeyDown.bind(this)),document.addEventListener("keyup",this.handleKeyUp.bind(this)),document.addEventListener("mousemove",this.handleMouseMove.bind(this)),document.addEventListener("mousedown",this.handleMouseDown.bind(this)),document.addEventListener("mouseup",this.handleMouseUp.bind(this)),this.canvas.addEventListener("contextmenu",t=>t.preventDefault()),document.addEventListener("pointerlockchange",this.handlePointerLockChange.bind(this))}requestPointerLock(t){this.onPointerLockChange=t,this.canvas.requestPointerLock()}exitPointerLock(){document.exitPointerLock()}resetMouseDelta(){this.mouseDelta.x=0,this.mouseDelta.y=0}handleKeyDown(t){this.updateKeyState(t.code,!0)}handleKeyUp(t){this.updateKeyState(t.code,!1)}updateKeyState(t,e){switch(t){case"KeyW":this.state.forward=e;break;case"KeyS":this.state.backward=e;break;case"KeyA":this.state.left=e;break;case"KeyD":this.state.right=e;break;case"ShiftLeft":case"ShiftRight":this.state.run=e;break;case"Space":this.state.jump=e;break;case"KeyR":this.state.reload=e;break}}handleMouseMove(t){if(!this.isPointerLocked)return;const e=this.invertX?-t.movementX:t.movementX,i=this.invertY?-t.movementY:t.movementY;this.mouseDelta.x+=e*this.sensitivity,this.mouseDelta.y+=i*this.sensitivity}handleMouseDown(t){t.button===0?this.state.fire=!0:t.button===2&&(t.preventDefault(),this.state.altFire=!0)}handleMouseUp(t){t.button===0?this.state.fire=!1:t.button===2&&(this.state.altFire=!1)}handlePointerLockChange(){this.isPointerLocked=document.pointerLockElement===this.canvas,this.onPointerLockChange?.()}destroy(){document.removeEventListener("keydown",this.handleKeyDown.bind(this)),document.removeEventListener("keyup",this.handleKeyUp.bind(this)),document.removeEventListener("mousemove",this.handleMouseMove.bind(this)),document.removeEventListener("mousedown",this.handleMouseDown.bind(this)),document.removeEventListener("mouseup",this.handleMouseUp.bind(this)),document.removeEventListener("pointerlockchange",this.handlePointerLockChange.bind(this))}}function T(x=0,t=0,e=0){return{x,y:t,z:e}}function _(x,t){return{x:x.x-t.x,y:x.y-t.y,z:x.z-t.z}}function C(x){return Math.sqrt(x.x*x.x+x.y*x.y+x.z*x.z)}function V(x){const t=C(x);return t===0?{x:0,y:0,z:0}:{x:x.x/t,y:x.y/t,z:x.z/t}}function z(x,t){return C(_(x,t))}function I(x,t,e){return Math.max(t,Math.min(e,x))}const F={walkSpeed:8,runSpeed:20,jumpForce:12,gravity:25,groundFriction:12,airControl:.85,mouseSensitivity:.002};class O{state;config;collision;stepSpeed=12;maxStepHeight=.5;targetYaw=0;targetPitch=-.05;airJumpCooldown=0;AIR_JUMP_COOLDOWN=2;airJumpsLeft=0;maxAirJumps=1;canAirJump=!1;rageMode=!1;rageModeTimer=0;speedBoost=1;speedBoostTimer=0;constructor(t=T(0,1.7,5),e={},i){this.config={...F,...e},this.collision=i,this.state={position:{...t},velocity:T(),yaw:0,pitch:-.05,grounded:!0,eyeHeight:1.7,health:100,maxHealth:100}}update(t,e,i){this.rageModeTimer>0&&(this.rageModeTimer-=t,this.rageModeTimer<=0&&(this.rageMode=!1)),this.speedBoostTimer>0&&(this.speedBoostTimer-=t,this.speedBoostTimer<=0&&(this.speedBoost=1)),this.airJumpCooldown>0&&(this.airJumpCooldown-=t),this.updateCamera(i),this.updateMovement(t,e)}activateStimpack(){this.rageMode=!0,this.rageModeTimer=8,this.speedBoost=1.8,this.speedBoostTimer=8}tryDoubleJump(){return!this.canAirJump||this.airJumpsLeft<=0?!1:this.rageMode?(this.state.velocity.y=this.config.jumpForce*.9,this.airJumpsLeft--,this.canAirJump=!1,!0):this.airJumpCooldown<=0?(this.airJumpCooldown=this.AIR_JUMP_COOLDOWN,this.state.velocity.y=this.config.jumpForce,this.airJumpsLeft--,this.canAirJump=!1,!0):!1}onJumpReleased(){this.state.grounded||(this.canAirJump=!0)}getDoubleJumpCooldown(){return Math.max(0,this.airJumpCooldown)}isDoubleJumpReady(){return this.airJumpCooldown<=0&&this.airJumpsLeft>0||this.rageMode}unlockTripleJump(){this.maxAirJumps=2}getAirJumpsLeft(){return this.airJumpsLeft}updateCamera(t){this.targetYaw-=t.x,this.targetPitch+=t.y,this.targetPitch=I(this.targetPitch,-Math.PI/2+.01,Math.PI/2-.01),this.state.yaw+=(this.targetYaw-this.state.yaw)*.7,this.state.pitch+=(this.targetPitch-this.state.pitch)*.7}updateMovement(t,e){const{state:i,config:s}=this;let n=0,a=0;e.forward&&(a-=1),e.backward&&(a+=1),e.left&&(n-=1),e.right&&(n+=1);const o=Math.sqrt(n*n+a*a);o>0&&(n/=o,a/=o);const r=Math.sin(i.yaw),c=Math.cos(i.yaw),h=n*c-a*r,l=n*r+a*c,p=(e.run?s.runSpeed:s.walkSpeed)*this.speedBoost,m=h*p,f=l*p,y=this.collision.getFloorHeight(i.position)+i.eyeHeight;if(i.grounded){const k=s.groundFriction*t;if(i.velocity.x+=(m-i.velocity.x)*Math.min(k,1),i.velocity.z+=(f-i.velocity.z)*Math.min(k,1),e.jump)i.velocity.y=s.jumpForce,i.grounded=!1,this.airJumpsLeft=this.maxAirJumps,this.canAirJump=!1;else{const A=y-i.position.y;Math.abs(A)<.01?(i.position.y=y,i.velocity.y=0):A>0&&A<this.maxStepHeight?i.velocity.y=this.stepSpeed:A<0&&A>-this.maxStepHeight?i.velocity.y=-this.stepSpeed*.8:A<-this.maxStepHeight&&(i.grounded=!1,i.velocity.y=0)}}else{const k=8*t;i.velocity.x+=(m-i.velocity.x)*Math.min(k,1),i.velocity.z+=(f-i.velocity.z)*Math.min(k,1),i.velocity.y-=s.gravity*t}const v=i.position.x+i.velocity.x*t,b=i.position.y+i.velocity.y*t,g=i.position.z+i.velocity.z*t,w={x:v,y:i.position.y,z:i.position.z};this.collision.checkCollision(w)?i.velocity.x=0:i.position.x=v;const q={x:i.position.x,y:i.position.y,z:g};this.collision.checkCollision(q)?i.velocity.z=0:i.position.z=g;const G=this.collision.getFloorHeight(i.position)+i.eyeHeight;if(i.grounded)i.position.y+=i.velocity.y*t,i.position.y<G&&(i.position.y=G,i.velocity.y=0);else if(b<=G)i.position.y=G,i.velocity.y=0,i.grounded=!0,this.canAirJump=!1,this.airJumpsLeft=0;else{const k={x:i.position.x,y:b,z:i.position.z},A=this.collision.getCeilingHeight(i.position);b<A-.3&&!this.collision.checkCollision(k)?i.position.y=b:i.velocity.y=Math.min(i.velocity.y,0)}}getEyePosition(){return{x:this.state.position.x,y:this.state.position.y,z:this.state.position.z}}getLookDirection(){const{yaw:t,pitch:e}=this.state;return{x:Math.sin(t)*Math.cos(e),y:Math.sin(e),z:-Math.cos(t)*Math.cos(e)}}takeDamage(t){this.state.health=Math.max(0,this.state.health-t)}heal(t){this.state.health=Math.min(this.state.maxHealth,this.state.health+t)}isDead(){return this.state.health<=0}reset(t){this.state.position={...t},this.state.velocity=T(),this.state.health=this.state.maxHealth,this.state.grounded=!0}}class D{state;currentWeapon="katana";splashCharges=0;attackCooldown=0;attackDuration=.3;attackCooldownTime=.4;attackRange=4;attackAngle=Math.PI*.6;damage=100;isAttacking=!1;attackProgress=0;onSlice;onSplash;isSplashAttack=!1;splashRadius=10;constructor(){this.state={ammo:999,reserveAmmo:999,magazineSize:999,isReloading:!1,reloadTimeLeft:0,recoilX:0,recoilY:0,recoilBack:0,muzzleFlash:0,bobPhase:0}}update(t,e,i){if(this.attackCooldown>0&&(this.attackCooldown-=t),this.isAttacking&&(this.attackProgress+=t/this.attackDuration,this.attackProgress>=1&&(this.isAttacking=!1,this.attackProgress=0)),e){const s=i?14:10;this.state.bobPhase+=t*s}else this.state.bobPhase*=.95;this.state.recoilX*=.85,this.state.recoilY*=.85,this.state.muzzleFlash*=.8}tryAttack(){return this.attackCooldown>0||this.isAttacking?!1:(this.attack(!1),!0)}trySplashAttack(){return this.attackCooldown>0||this.isAttacking||this.splashCharges<=0?!1:(this.attack(!0),!0)}attack(t){this.isAttacking=!0,this.attackProgress=0,this.attackCooldown=t?.6:this.attackCooldownTime,this.isSplashAttack=t,t?(this.splashCharges--,this.state.recoilX=.6,this.state.muzzleFlash=2,this.splashCharges<=0&&(this.currentWeapon="katana"),this.onSplash?.()):(this.state.recoilX=.3,this.state.muzzleFlash=1,this.onSlice?.())}chargeKatana(){this.currentWeapon="charged",this.splashCharges=3}isCharged(){return this.splashCharges>0}checkHit(t,e,i){if(!this.isAttacking||this.attackProgress<.2||this.attackProgress>.6)return!1;const s=i.x-t.x,n=i.z-t.z,a=Math.sqrt(s*s+n*n);if(this.isSplashAttack)return a<=this.splashRadius;if(a>this.attackRange)return!1;let r=Math.atan2(s,-n)-e;for(;r>Math.PI;)r-=Math.PI*2;for(;r<-Math.PI;)r+=Math.PI*2;return Math.abs(r)<this.attackAngle/2}getWeaponOffset(){const t=Math.sin(this.state.bobPhase)*.02,e=Math.abs(Math.sin(this.state.bobPhase*2))*.015;let i=0,s=0;if(this.isAttacking){const n=this.attackProgress;i=Math.sin(n*Math.PI)*.3,s=-Math.sin(n*Math.PI*2)*.1}return{x:t+this.state.recoilX+i,y:e-this.state.recoilY+s,z:0}}tryShoot(t,e){return this.tryAttack()}startReload(){return!1}projectiles=[]}class R{ctx;width;height;attackProgress=0;isAttacking=!1;isSplashAttack=!1;splashCharges=0;hitFlash=0;particles=[];static MAX_PARTICLES=50;splashWaveActive=!1;splashWaveProgress=0;splashWaveYaw=0;constructor(t){this.ctx=t.getContext("2d"),this.width=t.width,this.height=t.height}resize(t,e){this.width=t,this.height=e}showHitEffect(){this.hitFlash=1,this.spawnFragments()}showSplashEffect(){this.hitFlash=1.2,this.spawnAxeSplash()}showSplashWave(t){this.splashWaveActive=!0,this.splashWaveProgress=0,this.splashWaveYaw=t,this.hitFlash=1.5,this.spawnWaveParticles()}spawnWaveParticles(){if(this.particles.length>R.MAX_PARTICLES)return;const t=this.width/2,e=this.height/2,i=["#00ffff","#00e5ff","#00bfff","#40e0d0"];for(let s=0;s<12;s++){const n=s/12*Math.PI-Math.PI/2,a=600+Math.random()*300;this.particles.push({x:t,y:e,vx:Math.cos(n)*a,vy:Math.sin(n)*a*.3,size:5+Math.random()*6,color:i[s%i.length],life:.4+Math.random()*.3,maxLife:.4+Math.random()*.3,type:"spark"})}for(let s=0;s<6;s++){const n=(Math.random()-.5)*Math.PI*.8,a=600+Math.random()*300;this.particles.push({x:t+(Math.random()-.5)*100,y:e+(Math.random()-.5)*50,vx:Math.cos(n)*a,vy:Math.sin(n)*a*.2,size:12+Math.random()*18,color:i[Math.floor(Math.random()*i.length)],life:.8+Math.random()*.4,maxLife:.8+Math.random()*.4,type:"fragment"})}}spawnFragments(){if(this.particles.length>R.MAX_PARTICLES)return;const t=this.width/2,e=this.height/2,i=["#00ff00","#33ff00","#66ff33","#00ff66"];for(let s=0;s<6;s++){const n=s/6*Math.PI*2+Math.random()*.5,a=400+Math.random()*400;this.particles.push({x:t+(Math.random()-.5)*40,y:e+(Math.random()-.5)*40,vx:Math.cos(n)*a,vy:Math.sin(n)*a-150,size:6+Math.random()*8,color:i[s%i.length],life:.5+Math.random()*.3,maxLife:.5+Math.random()*.3,type:"fragment"})}for(let s=0;s<10;s++){const n=Math.random()*Math.PI*2,a=200+Math.random()*300;this.particles.push({x:t+(Math.random()-.5)*20,y:e+(Math.random()-.5)*20,vx:Math.cos(n)*a,vy:Math.sin(n)*a-80,size:2+Math.random()*3,color:i[s%i.length],life:.3+Math.random()*.2,maxLife:.3+Math.random()*.2,type:"spark"})}}updateParticles(t){const i=this.height+50;let s=0;for(let n=0;n<this.particles.length;n++){const a=this.particles[n];a.x+=a.vx*t,a.y+=a.vy*t,a.vy+=800*t,a.vx*=.98,a.life-=t,a.life>0&&a.y<i&&(this.particles[s++]=a)}this.particles.length=s}renderParticles(t){t.shadowBlur=0;for(const e of this.particles){const i=Math.min(1,e.life/e.maxLife*2);t.globalAlpha=i,t.fillStyle=e.color,e.type==="fragment"?(t.beginPath(),t.arc(e.x,e.y,e.size,0,Math.PI*2),t.fill(),t.globalAlpha=i*.8,t.fillStyle="#ffffff",t.beginPath(),t.arc(e.x,e.y,e.size*.4,0,Math.PI*2),t.fill()):(t.beginPath(),t.arc(e.x,e.y,e.size,0,Math.PI*2),t.fill(),t.globalAlpha=i*.5,t.strokeStyle=e.color,t.lineWidth=e.size*.5,t.beginPath(),t.moveTo(e.x,e.y),t.lineTo(e.x-e.vx*.02,e.y-e.vy*.02),t.stroke())}t.globalAlpha=1}render(t,e){const i=this.ctx;i.clearRect(0,0,this.width,this.height),this.updateParticles(1/60),this.splashWaveActive&&(this.splashWaveProgress+=.03,this.splashWaveProgress>=1&&(this.splashWaveActive=!1));const s=Math.min(this.width,this.height)/600,n=Math.sin(t.bobPhase)*8*s,a=Math.abs(Math.sin(t.bobPhase*2))*6*s;this.hitFlash>0&&(this.hitFlash-=.04),this.splashWaveActive&&this.drawSplashWaveEffect(i,e),i.save();let o=this.width*.65,r=this.height*.8,c=-.4;if(this.isAttacking){const h=this.attackProgress,l=1-Math.pow(1-h,3);c=-.4-Math.sin(l*Math.PI)*(this.isSplashAttack?3.2:2.5);const p=this.isSplashAttack?1.5:1;o-=Math.sin(h*Math.PI)*this.width*.3*p,r-=Math.sin(h*Math.PI)*this.height*.15*p}i.translate(o+n,r+a),i.rotate(c),i.scale(s,s),this.isAttacking&&this.attackProgress>.05&&this.attackProgress<.8&&(this.isSplashAttack?this.drawSplashSlash(i,this.attackProgress,e):this.drawRetrowaveSlash(i,this.attackProgress,e)),this.drawKatana(i,t,e),this.splashCharges>0&&this.drawChargeIndicator(i,e),this.hitFlash>0&&this.drawHitGlow(i,this.hitFlash,this.isSplashAttack?"charged":"katana"),i.restore(),this.renderParticles(i),this.hitFlash>.5&&this.drawScreenFlash(i,this.isSplashAttack?"charged":"katana")}drawChargeIndicator(t,e){t.save(),t.shadowColor="#00ffff",t.shadowBlur=15;for(let i=0;i<3;i++){const s=-50-i*60,n=.7+.3*Math.sin(e*5+i);this.splashCharges>i?(t.fillStyle=`rgba(0, 255, 255, ${n})`,t.beginPath(),t.arc(0,s,8,0,Math.PI*2),t.fill(),t.strokeStyle=`rgba(0, 255, 255, ${n*.5})`,t.lineWidth=2,t.beginPath(),t.arc(0,s,12+Math.sin(e*8+i)*3,0,Math.PI*2),t.stroke()):(t.fillStyle="rgba(100, 100, 100, 0.3)",t.beginPath(),t.arc(0,s,6,0,Math.PI*2),t.fill())}t.restore()}drawSplashWaveEffect(t,e){const i=this.width/2,s=this.height/2,n=Math.max(this.width,this.height)*.8,a=this.splashWaveProgress*n;t.save();for(let r=0;r<3;r++){const c=a-r*30;if(c>0){const h=(1-this.splashWaveProgress)*(.5-r*.1);t.strokeStyle=`rgba(0, 255, 255, ${h})`,t.lineWidth=8-r*2,t.shadowColor="#00ffff",t.shadowBlur=20,t.beginPath(),t.ellipse(i,s+100,c,c*.3,0,Math.PI,0),t.stroke(),r===0&&(t.strokeStyle=`rgba(255, 255, 255, ${h*.8})`,t.lineWidth=2,t.beginPath(),t.ellipse(i,s+100,c-5,(c-5)*.3,0,Math.PI,0),t.stroke())}}const o=Math.floor((1-this.splashWaveProgress)*20);t.fillStyle="#ffffff";for(let r=0;r<o;r++){const c=Math.PI+Math.random()*Math.PI,h=a+(Math.random()-.5)*20,l=i+Math.cos(c)*h,u=s+100+Math.sin(c)*h*.3,p=2+Math.random()*4;t.beginPath(),t.arc(l,u,p,0,Math.PI*2),t.fill()}t.restore()}drawSplashSlash(t,e,i){t.save(),t.globalCompositeOperation="lighter";const s=t.createLinearGradient(-200,-350,50,0);s.addColorStop(0,"rgba(0, 255, 255, 0)"),s.addColorStop(.3,"rgba(0, 255, 255, 0.8)"),s.addColorStop(.6,"rgba(0, 255, 255, 1)"),s.addColorStop(1,"rgba(0, 255, 255, 0)"),t.strokeStyle=s,t.lineWidth=30+Math.sin(e*Math.PI)*20,t.lineCap="round",t.shadowColor="#00ffff",t.shadowBlur=40,t.beginPath(),t.moveTo(-200,-350),t.quadraticCurveTo(-100+Math.sin(i*30)*20,-200,50,0),t.stroke(),t.strokeStyle="rgba(255, 255, 255, 0.9)",t.lineWidth=6,t.shadowBlur=20,t.stroke();for(let n=0;n<3;n++){const a=n*15;t.strokeStyle=`rgba(0, 200, 255, ${.4-n*.1})`,t.lineWidth=4-n,t.beginPath(),t.moveTo(-200-a,-350+a),t.quadraticCurveTo(-100-a+Math.sin(i*30+n)*15,-200+a,50-a,0+a),t.stroke()}t.restore()}drawKatana(t,e,i){t.fillStyle="#8a7a6a",t.beginPath(),t.ellipse(0,80,40,50,.2,0,Math.PI*2),t.fill();const s=t.createLinearGradient(0,40,0,160);s.addColorStop(0,"#2a1a1a"),s.addColorStop(.5,"#1a0a0a"),s.addColorStop(1,"#2a1a1a"),t.fillStyle=s,t.beginPath(),t.moveTo(-14,40),t.lineTo(14,40),t.lineTo(12,160),t.lineTo(-12,160),t.closePath(),t.fill(),t.strokeStyle="#ff00ff",t.shadowColor="#ff00ff",t.shadowBlur=10,t.lineWidth=2;for(let a=0;a<10;a++){const o=50+a*11,r=.5+.5*Math.sin(i*3+a*.5);t.strokeStyle=`rgba(255, 0, 255, ${r})`,t.beginPath(),t.moveTo(-12,o),t.lineTo(0,o+5),t.lineTo(12,o),t.stroke()}t.shadowBlur=0,t.fillStyle="#1a1a2a",t.beginPath(),t.ellipse(0,35,35,12,0,0,Math.PI*2),t.fill(),t.strokeStyle="#00ffff",t.shadowColor="#00ffff",t.shadowBlur=15,t.lineWidth=2,t.beginPath(),t.ellipse(0,35,32,10,0,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const n=t.createLinearGradient(-10,0,10,0);n.addColorStop(0,"#8080a0"),n.addColorStop(.3,"#c0c0e0"),n.addColorStop(.5,"#ffffff"),n.addColorStop(.7,"#c0c0e0"),n.addColorStop(1,"#6060a0"),t.fillStyle=n,t.beginPath(),t.moveTo(-10,30),t.lineTo(10,30),t.lineTo(7,-280),t.lineTo(0,-320),t.lineTo(-5,-280),t.closePath(),t.fill(),t.strokeStyle="#00ffff",t.shadowColor="#00ffff",t.shadowBlur=8,t.lineWidth=2,t.beginPath(),t.moveTo(9,30),t.lineTo(6,-280),t.lineTo(0,-320),t.stroke(),t.strokeStyle=`rgba(255, 0, 255, ${.5+.3*Math.sin(i*4)})`,t.shadowColor="#ff00ff",t.shadowBlur=5,t.lineWidth=1.5,t.beginPath(),t.moveTo(-4,30);for(let a=0;a<25;a++){const o=30-a*13,r=Math.sin(a*.7+i*2)*4;t.lineTo(-4+r,o)}t.stroke(),t.shadowBlur=0,t.fillStyle="rgba(255, 255, 255, 0.4)",t.beginPath(),t.moveTo(3,25),t.lineTo(5,25),t.lineTo(3,-270),t.lineTo(1,-270),t.closePath(),t.fill()}drawRetrowaveSlash(t,e,i){t.save(),t.translate(0,-150);const s=Math.sin(e*Math.PI),n=[{color:"#ff00ff",offset:0},{color:"#00ffff",offset:15},{color:"#ff0080",offset:30},{color:"#8000ff",offset:45}];for(const{color:a,offset:o}of n)t.strokeStyle=a,t.shadowColor=a,t.shadowBlur=25,t.lineWidth=10-o*.15,t.lineCap="round",t.beginPath(),t.arc(0,100,200+o,-Math.PI*.7,Math.PI*.15),t.globalAlpha=s*(1-o*.015),t.stroke();t.globalAlpha=s;for(let a=0;a<15;a++){const o=-Math.PI*.7+Math.PI*.85*(a/15)+Math.sin(i*10+a)*.1,r=200+Math.random()*50,c=Math.cos(o)*r,h=100+Math.sin(o)*r,l=a%2===0?"#ff00ff":"#00ffff";t.fillStyle=l,t.shadowColor=l,t.shadowBlur=15,t.beginPath(),t.arc(c,h,4+Math.random()*4,0,Math.PI*2),t.fill()}t.globalAlpha=1,t.shadowBlur=0,t.restore()}drawAxe(t,e,i,s){t.fillStyle="#8a7a6a",t.beginPath(),t.ellipse(0,80,40,50,.2,0,Math.PI*2),t.fill();const n=t.createLinearGradient(0,40,0,160);n.addColorStop(0,"#3a2010"),n.addColorStop(.5,"#2a1005"),n.addColorStop(1,"#3a2010"),t.fillStyle=n,t.beginPath(),t.moveTo(-14,40),t.lineTo(14,40),t.lineTo(12,160),t.lineTo(-12,160),t.closePath(),t.fill(),t.strokeStyle="#ff6600",t.shadowColor="#ff6600",t.shadowBlur=10,t.lineWidth=2;for(let o=0;o<10;o++){const r=50+o*11,c=.5+.5*Math.sin(i*4+o*.5);t.strokeStyle=`rgba(255, 100, 0, ${c})`,t.beginPath(),t.moveTo(-12,r),t.lineTo(0,r+5),t.lineTo(12,r),t.stroke()}t.shadowBlur=0,t.fillStyle="#2a2020",t.beginPath(),t.rect(-30,25,60,20),t.fill(),t.strokeStyle="#ff6600",t.shadowColor="#ff6600",t.shadowBlur=15,t.lineWidth=2,t.strokeRect(-28,27,56,16),t.shadowBlur=0;const a=t.createLinearGradient(-40,0,40,0);a.addColorStop(0,"#6060a0"),a.addColorStop(.2,"#8080b0"),a.addColorStop(.4,"#b0b0d0"),a.addColorStop(.5,"#e0e0f0"),a.addColorStop(.6,"#b0b0d0"),a.addColorStop(.8,"#8080b0"),a.addColorStop(1,"#6060a0"),t.fillStyle=a,t.beginPath(),t.moveTo(-12,20),t.lineTo(12,20),t.lineTo(15,-50),t.lineTo(50,-180),t.lineTo(55,-220),t.lineTo(0,-300),t.lineTo(-55,-220),t.lineTo(-50,-180),t.lineTo(-15,-50),t.closePath(),t.fill(),t.strokeStyle="#ff6600",t.shadowColor="#ff6600",t.shadowBlur=12,t.lineWidth=3,t.beginPath(),t.moveTo(14,20),t.lineTo(52,-180),t.lineTo(57,-220),t.lineTo(0,-305),t.stroke(),t.beginPath(),t.moveTo(-14,20),t.lineTo(-52,-180),t.lineTo(-57,-220),t.lineTo(0,-305),t.stroke(),t.strokeStyle=`rgba(255, 150, 0, ${.5+.3*Math.sin(i*5)})`,t.shadowColor="#ff9900",t.shadowBlur=8,t.lineWidth=2,t.beginPath(),t.moveTo(0,15);for(let o=0;o<20;o++){const r=15-o*15,c=Math.sin(o*.8+i*3)*(3+o*.3);t.lineTo(c,r)}t.stroke(),t.shadowBlur=0;for(let o=0;o<5;o++){const r=-50-o*45;o<s?(t.fillStyle="#ff8800",t.shadowColor="#ff8800",t.shadowBlur=15):(t.fillStyle="#333333",t.shadowColor="transparent",t.shadowBlur=0),t.beginPath(),t.arc(0,r,4,0,Math.PI*2),t.fill()}t.shadowBlur=0,t.fillStyle="rgba(255, 255, 255, 0.4)",t.beginPath(),t.moveTo(5,15),t.lineTo(8,15),t.lineTo(40,-170),t.lineTo(37,-170),t.closePath(),t.fill()}drawAxeSlash(t,e,i){t.save(),t.translate(0,-150);const s=Math.sin(e*Math.PI),n=[{color:"#ff6600",offset:0},{color:"#ff9900",offset:15},{color:"#ff3300",offset:30},{color:"#ffcc00",offset:45}];for(const{color:a,offset:o}of n)t.strokeStyle=a,t.shadowColor=a,t.shadowBlur=25,t.lineWidth=12-o*.15,t.lineCap="round",t.beginPath(),t.arc(0,100,200+o,-Math.PI*.7,Math.PI*.15),t.globalAlpha=s*(1-o*.015),t.stroke();t.globalAlpha=s;for(let a=0;a<15;a++){const o=-Math.PI*.7+Math.PI*.85*(a/15)+Math.sin(i*10+a)*.1,r=200+Math.random()*50,c=Math.cos(o)*r,h=100+Math.sin(o)*r,l=a%2===0?"#ff6600":"#ffaa00";t.fillStyle=l,t.shadowColor=l,t.shadowBlur=15,t.beginPath(),t.arc(c,h,4+Math.random()*4,0,Math.PI*2),t.fill()}t.globalAlpha=1,t.shadowBlur=0,t.restore()}spawnAxeSplash(){if(this.particles.length>R.MAX_PARTICLES)return;const t=this.width/2,e=this.height/2,i=["#ff6600","#ff9900","#ff3300","#ffcc00"];for(let s=0;s<8;s++){const n=s/8*Math.PI*2+Math.random()*.3,a=400+Math.random()*500;this.particles.push({x:t+(Math.random()-.5)*60,y:e+(Math.random()-.5)*60,vx:Math.cos(n)*a,vy:Math.sin(n)*a-120,size:8+Math.random()*10,color:i[s%i.length],life:.5+Math.random()*.3,maxLife:.5+Math.random()*.3,type:"fragment"})}for(let s=0;s<12;s++){const n=Math.random()*Math.PI*2,a=250+Math.random()*400;this.particles.push({x:t+(Math.random()-.5)*30,y:e+(Math.random()-.5)*30,vx:Math.cos(n)*a,vy:Math.sin(n)*a-80,size:2+Math.random()*4,color:i[s%i.length],life:.3+Math.random()*.3,maxLife:.3+Math.random()*.3,type:"spark"})}}drawHitGlow(t,e,i="katana"){if(t.save(),t.globalAlpha=e,i==="charged"){t.strokeStyle="#ffffff",t.shadowColor="#00ffff",t.shadowBlur=50*e,t.lineWidth=10,t.beginPath(),t.moveTo(9,30),t.lineTo(6,-280),t.lineTo(0,-320),t.stroke(),t.strokeStyle="#00ffff",t.shadowColor="#0088ff",t.shadowBlur=30*e,t.lineWidth=4;for(let s=0;s<3;s++)t.beginPath(),t.arc(0,-150,50+s*30,0,Math.PI*2),t.stroke()}else t.strokeStyle="#ffffff",t.shadowColor="#00ffff",t.shadowBlur=30*e,t.lineWidth=6,t.beginPath(),t.moveTo(9,30),t.lineTo(6,-280),t.lineTo(0,-320),t.stroke(),t.strokeStyle="#ff00ff",t.shadowColor="#ff00ff",t.shadowBlur=20*e,t.lineWidth=3,t.stroke();t.restore()}drawScreenFlash(t,e="katana"){t.save(),t.resetTransform();const i=t.createRadialGradient(this.width/2,this.height/2,0,this.width/2,this.height/2,this.width);e==="charged"?(i.addColorStop(0,`rgba(255, 255, 255, ${this.hitFlash*.6})`),i.addColorStop(.2,`rgba(0, 255, 255, ${this.hitFlash*.4})`),i.addColorStop(.5,`rgba(0, 150, 255, ${this.hitFlash*.2})`),i.addColorStop(.8,`rgba(0, 80, 255, ${this.hitFlash*.1})`),i.addColorStop(1,"rgba(0, 0, 0, 0)")):(i.addColorStop(0,`rgba(255, 255, 255, ${this.hitFlash*.4})`),i.addColorStop(.3,`rgba(255, 0, 255, ${this.hitFlash*.2})`),i.addColorStop(.6,`rgba(0, 255, 255, ${this.hitFlash*.1})`),i.addColorStop(1,"rgba(0, 0, 0, 0)")),t.fillStyle=i,t.fillRect(0,0,this.width,this.height),t.restore()}}class M{position;velocity=T();radius=.8;active=!0;speed=4;fireIntensity=1;fragments=[];removeTimer=0;id;phase;moveType;enemyType="baneling";damage=25;currentSpeed=0;isCharging=!0;chargeDirection=T();passedThroughTimer=0;verticalVelocity=0;onGround=!0;hopTimer=0;dodgeAngle=0;dodgeTimer=0;isAttached=!1;attachTimer=0;orbitAngle=0;hp=1;maxHp=1;isBoss=!1;teleportTimer=0;distortionPower=0;spawnPhantomTimer=5;isVortexActive=!1;vortexTimer=0;vortexCooldown=0;vortexWarningPlayed=!1;onSpawnPhantom;onVortexStart;onVortexEnd;onVortexWarning;poolTimer=0;spitTimer=0;spitCooldown=3;greenBossRole="hunter";lastPlayerPos=T();playerVelocity=T();onSpit;onAcidRainMark;bossPhase=1;onPhaseChange;collision=null;constructor(t,e=4,i=0,s="baneling",n){this.position={...t},this.speed=e,this.id=i,this.phase=Math.random()*Math.PI*2,this.moveType=i%4,this.enemyType=s,this.collision=n||null,s==="phantom"?(this.speed=e*2,this.damage=10,this.radius=.6,this.currentSpeed=0,this.isCharging=!0):s==="runner"?(this.speed=e*2.5,this.damage=15,this.radius=.4,this.position.y=.5):s==="hopper"?(this.speed=e*1.2,this.damage=20,this.radius=.5,this.verticalVelocity=8,this.onGround=!1):s==="boss_green"?(this.isBoss=!0,this.speed=e*.6,this.damage=40,this.radius=2.5,this.hp=10,this.maxHp=10,this.spitCooldown=3):s==="boss_black"?(this.isBoss=!0,this.speed=e*.8,this.damage=30,this.radius=2,this.hp=70,this.maxHp=70,this.distortionPower=1):s==="boss_blue"?(this.isBoss=!0,this.speed=e*1.5,this.damage=25,this.radius=1.8,this.hp=24,this.maxHp=24,this.teleportTimer=3):(this.damage=25,this.currentSpeed=e)}update(t,e,i){if(this.fireIntensity=.6+Math.sin(i*8+this.id)*.4,this.active)switch(this.enemyType){case"phantom":this.updatePhantom(t,e,i);break;case"runner":this.updateRunner(t,e,i);break;case"hopper":this.updateHopper(t,e,i);break;case"boss_green":this.updateBossGreen(t,e,i);break;case"boss_black":this.updateBossBlack(t,e,i);break;case"boss_blue":this.updateBossBlue(t,e,i);break;default:this.updateBaneling(t,e,i)}this.updateFragments(t),!this.active&&this.removeTimer>0&&(this.removeTimer-=t)}updateBaneling(t,e,i){const s=e.x-this.position.x,n=e.y-.3-this.position.y,a=e.z-this.position.z,o=Math.sqrt(s*s+n*n+a*a);if(o>.1){const r=s/o,c=n/o,h=a/o,l=1+Math.max(0,(15-o)/15)*.8,u=this.speed*l;let p=0,m=0,f=0;const d=i*4+this.phase;switch(this.moveType){case 0:p=Math.cos(d)*3,f=Math.sin(d)*3,m=Math.sin(d*.5)*1.5;break;case 1:p=Math.sin(d*2)*4,m=Math.cos(d)*.5;break;case 2:m=Math.sin(d*1.5)*2.5,p=Math.cos(d*.7)*1;break;case 3:const w=Math.sin(d)>0?1.5:.5;p=Math.cos(d*3)*2*w,f=Math.sin(d*3)*2*w;break}const y=-h,v=r;this.velocity.x=r*u+y*p*.3+p*.1,this.velocity.y=c*u+m*.3,this.velocity.z=h*u+v*f*.3+f*.1;const b=this.position.x+this.velocity.x*t,g=this.position.z+this.velocity.z*t;!this.collision?.checkEnemyCollision||!this.collision.checkEnemyCollision({x:b,y:this.position.y,z:g},this.radius)?(this.position.x=b,this.position.z=g):this.velocity.y+=5*t,this.position.y+=this.velocity.y*t,this.position.y=Math.max(.5,Math.min(6,this.position.y))}}updatePhantom(t,e,i){const s=e.x-this.position.x,n=e.y-.3-this.position.y,a=e.z-this.position.z,o=Math.sqrt(s*s+n*n+a*a);if(this.isCharging){this.currentSpeed=Math.min(this.currentSpeed+t*15,this.speed),o>.1&&(this.chargeDirection.x=s/o,this.chargeDirection.y=n/o,this.chargeDirection.z=a/o);const r=Math.sin(i*10)*.3;this.velocity.x=this.chargeDirection.x*this.currentSpeed+r,this.velocity.y=this.chargeDirection.y*this.currentSpeed,this.velocity.z=this.chargeDirection.z*this.currentSpeed,this.currentSpeed>=this.speed*.9&&(this.isCharging=!1)}else this.passedThroughTimer+=t,this.velocity.x=this.chargeDirection.x*this.speed,this.velocity.y=this.chargeDirection.y*this.speed,this.velocity.z=this.chargeDirection.z*this.speed,this.passedThroughTimer>2.5&&(this.isCharging=!0,this.currentSpeed=this.speed*.3,this.passedThroughTimer=0);this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.position.y=Math.max(.5,Math.min(4,this.position.y)),o>35&&(this.isCharging=!0,this.currentSpeed=0,this.passedThroughTimer=0)}runnerVerticalVel=0;runnerOnGround=!0;updateRunner(t,e,i){if(this.isAttached){this.attachTimer-=t,this.orbitAngle+=t*12;const o=1.2,r=Math.sin(i*8)*.3;this.position.x=e.x+Math.cos(this.orbitAngle)*o,this.position.y=e.y+r,this.position.z=e.z+Math.sin(this.orbitAngle)*o,this.attachTimer<=0&&(this.isAttached=!1,this.active=!1,this.removeTimer=.5);return}const s=e.x-this.position.x,n=e.z-this.position.z,a=Math.sqrt(s*s+n*n);if(a<1.5){this.isAttached=!0,this.attachTimer=3,this.orbitAngle=Math.atan2(n,s);return}if(a>.1){const o=s/a,r=n/a;if(this.collision?.getObstacleHeight&&this.runnerOnGround){const v=this.collision.getObstacleHeight(this.position,o,r,1.5);v>this.position.y&&v<10&&(this.runnerVerticalVel=12,this.runnerOnGround=!1)}if(this.collision?.checkEnemyCollision){const v={x:this.position.x+o*this.speed*t,y:this.position.y,z:this.position.z+r*this.speed*t};this.collision.checkEnemyCollision(v,this.radius)&&(this.dodgeAngle=(Math.random()>.5?1:-1)*Math.PI*.5)}this.dodgeTimer-=t,this.dodgeTimer<=0&&(this.dodgeAngle=(Math.random()-.5)*Math.PI*.8,this.dodgeTimer=.3+Math.random()*.4);const c=Math.cos(this.dodgeAngle),h=Math.sin(this.dodgeAngle),l=o*c-r*h,u=o*h+r*c,p=1+Math.max(0,(10-a)/10)*.5,m=this.speed*p,f=Math.sin(i*15+this.phase)*2;this.velocity.x=l*m+f*.3,this.velocity.z=u*m;const d=this.position.x+this.velocity.x*t,y=this.position.z+this.velocity.z*t;(!this.collision?.checkEnemyCollision||!this.collision.checkEnemyCollision({x:d,y:this.position.y,z:y},this.radius))&&(this.position.x=d,this.position.z=y),this.runnerOnGround?this.position.y=.5+Math.abs(Math.sin(i*20))*.1:(this.runnerVerticalVel-=25*t,this.position.y+=this.runnerVerticalVel*t,this.position.y<=.5&&(this.position.y=.5,this.runnerVerticalVel=0,this.runnerOnGround=!0))}}applyKnockback(t,e,i){const s=Math.sqrt(t*t+e*e);s>0&&(this.velocity.x=t/s*i,this.velocity.z=e/s*i,this.velocity.y=i*.3),this.knockbackTimer=.3}knockbackTimer=0;detachRunner(){if(this.isAttached&&this.enemyType==="runner"){this.isAttached=!1;const t=this.orbitAngle+Math.PI;return this.velocity.x=Math.cos(t)*15,this.velocity.y=8,this.velocity.z=Math.sin(t)*15,this.attachTimer=0,!0}return!1}onCreatePool;updateBossGreen(t,e,i){if(this.knockbackTimer>0){this.knockbackTimer-=t,this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.velocity.x*=.9,this.velocity.y*=.9,this.velocity.z*=.9,this.velocity.y-=15*t,this.position.y=Math.max(this.radius,this.position.y);return}this.playerVelocity.x=(e.x-this.lastPlayerPos.x)/Math.max(t,.001),this.playerVelocity.z=(e.z-this.lastPlayerPos.z)/Math.max(t,.001),this.lastPlayerPos={...e};const s=e.x-this.position.x,n=e.y-this.position.y,a=e.z-this.position.z,o=Math.sqrt(s*s+n*n+a*a),r=this.bossPhase===2?2.8:2.5;if(this.radius=r+Math.sin(i*3)*.3,this.greenBossRole==="hunter"){this.spitTimer-=t;const c=this.bossPhase===2?5:8;if(this.spitTimer<=0&&o<25){this.spitTimer=c;const h=T(e.x,.05,e.z);this.onAcidRainMark?.(h),this.bossPhase===2&&setTimeout(()=>{this.onAcidRainMark?.(T(h.x+6,.05,h.z)),this.onAcidRainMark?.(T(h.x-6,.05,h.z))},800)}if(o>8){const h=s/o,l=a/o;this.velocity.x=h*this.speed*.5,this.velocity.z=l*this.speed*.5,this.position.x+=this.velocity.x*t,this.position.z+=this.velocity.z*t}this.position.y=Math.max(this.radius,this.position.y)}else{this.spitTimer-=t;const c=this.bossPhase===2?2:3.5;if(this.spitTimer<=0&&o<20){this.spitTimer=c;const h=T(e.x+(Math.random()-.5)*2,.05,e.z+(Math.random()-.5)*2),l=T(this.position.x,this.position.y+1,this.position.z);this.onSpit?.(l,h),this.bossPhase===2&&(setTimeout(()=>{const u=T(e.x+3,.05,e.z);this.onSpit?.(l,u)},300),setTimeout(()=>{const u=T(e.x-3,.05,e.z);this.onSpit?.(l,u)},600))}if(o>.1){const h=s/o,l=n/o,u=a/o,p=Math.sin(i*2)*.5,m=this.bossPhase===2?1.4:1;this.velocity.x=h*this.speed*m+p,this.velocity.y=l*this.speed*.3,this.velocity.z=u*this.speed*m,this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.position.y=Math.max(this.radius,this.position.y)}}}updateBossBlack(t,e,i){if(this.knockbackTimer>0){this.knockbackTimer-=t,this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.velocity.x*=.92,this.velocity.y*=.92,this.velocity.z*=.92,this.velocity.y-=10*t,this.position.y=Math.max(1,this.position.y);return}const s=e.x-this.position.x,n=e.y-this.position.y,a=e.z-this.position.z,o=Math.sqrt(s*s+n*n+a*a);if(this.spawnPhantomTimer-=t,this.spawnPhantomTimer<=0){this.spawnPhantomTimer=5;const m=Math.random()*Math.PI*2,f=3+Math.random()*2,d=T(this.position.x+Math.cos(m)*f,this.position.y,this.position.z+Math.sin(m)*f);this.onSpawnPhantom?.(d)}if(this.vortexCooldown-=t,this.isVortexActive){this.vortexTimer-=t,this.position.y=2+Math.sin(i*10)*.3,this.distortionPower=1.5+Math.sin(i*15)*.5,this.vortexTimer<=0&&(this.isVortexActive=!1,this.vortexCooldown=12,this.vortexWarningPlayed=!1,this.onVortexEnd?.());return}this.vortexCooldown>0&&this.vortexCooldown<=2&&!this.vortexWarningPlayed&&o<15&&(this.vortexWarningPlayed=!0,this.onVortexWarning?.()),this.vortexCooldown<=0&&o<15&&(this.isVortexActive=!0,this.vortexTimer=4,this.onVortexStart?.());const r=.5,c=8+Math.sin(i*.3)*3,h=Math.cos(i*r)*c,l=Math.sin(i*r)*c,u=h-this.position.x,p=l-this.position.z;this.velocity.x=u*.5+s/o*this.speed*.3,this.velocity.y=(1.5-this.position.y)*2,this.velocity.z=p*.5+a/o*this.speed*.3,this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.distortionPower=Math.max(0,1-o/20)}getVortexPull(t){if(!this.isVortexActive)return T(0,0,0);const e=this.position.x-t.x,i=this.position.z-t.z,s=Math.sqrt(e*e+i*i);if(s<.5)return T(0,0,0);const n=Math.max(0,1-s/20)*7.5;return T(e/s*n,0,i/s*n)}updateBossBlue(t,e,i){if(this.knockbackTimer>0){this.knockbackTimer-=t,this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.velocity.x*=.85,this.velocity.y*=.85,this.velocity.z*=.85,this.velocity.y-=20*t,this.position.y=Math.max(.5,this.position.y);return}if(this.teleportTimer-=t,this.teleportTimer<=0){const r=Math.random()*Math.PI*2,c=5+Math.random()*10;this.position.x=e.x+Math.cos(r)*c,this.position.y=1.5+Math.random()*2,this.position.z=e.z+Math.sin(r)*c,this.teleportTimer=2+Math.random()*2;return}const s=e.x-this.position.x,n=e.y-this.position.y,a=e.z-this.position.z,o=Math.sqrt(s*s+n*n+a*a);if(o>.1){const r=Math.sin(i*10)*3;this.velocity.x=s/o*this.speed+r*.5,this.velocity.y=n/o*this.speed*.5,this.velocity.z=a/o*this.speed,this.position.x+=this.velocity.x*t,this.position.y+=this.velocity.y*t,this.position.z+=this.velocity.z*t,this.position.y=Math.max(.5,Math.min(4,this.position.y))}}takeDamage(t=1){return this.hp-=t,this.enemyType==="boss_green"&&this.bossPhase===1&&this.hp<=this.maxHp/2&&(this.bossPhase=2,this.speed*=1.3,this.onPhaseChange?.(2)),this.hp<=0?(this.hp=0,!0):!1}updateHopper(t,e,i){const s=e.x-this.position.x,n=e.z-this.position.z,a=Math.sqrt(s*s+n*n),o=18;if(this.onGround)if(this.hopTimer-=t,this.hopTimer<=0){this.onGround=!1;let h=10+Math.random()*4;if(this.collision?.getObstacleHeight&&a>.1){const l=s/a,u=n/a,p=this.collision.getObstacleHeight(this.position,l,u,3);p>this.position.y&&(h=Math.max(h,(p-this.position.y+2)*3))}if(this.verticalVelocity=h,this.hopTimer=.5+Math.random()*.5,a>.1){const l=this.speed*1.5;this.velocity.x=s/a*l,this.velocity.z=n/a*l}}else this.velocity.x*=.9,this.velocity.z*=.9;else this.verticalVelocity-=o*t,a>.1&&(this.velocity.x+=s/a*t*3,this.velocity.z+=n/a*t*3);const r=this.position.x+this.velocity.x*t,c=this.position.z+this.velocity.z*t;!this.collision?.checkEnemyCollision||!this.collision.checkEnemyCollision({x:r,y:this.position.y,z:c},this.radius)?(this.position.x=r,this.position.z=c):(this.velocity.x*=-.5,this.velocity.z*=-.5),this.position.y+=this.verticalVelocity*t,this.position.y<=.5&&(this.position.y=.5,this.onGround=!0,this.verticalVelocity=0),this.position.y=Math.min(12,this.position.y)}updateFragments(t){for(let i=this.fragments.length-1;i>=0;i--){const s=this.fragments[i];s.position.x+=s.velocity.x*t,s.position.y+=s.velocity.y*t,s.position.z+=s.velocity.z*t,s.velocity.y-=15*t,s.rotation+=s.rotationSpeed*t,s.lifetime-=t,(s.lifetime<=0||s.position.y<-5)&&this.fragments.splice(i,1)}}checkPlayerCollision(t){return this.active?z(this.position,t)<this.radius+.5:!1}slice(t){if(!this.active)return;this.active=!1,this.removeTimer=3;const e=4+Math.floor(Math.random()*4);for(let i=0;i<e;i++){const s=Math.random()*Math.PI*2,n=Math.random()*Math.PI*.5,a=8+Math.random()*12,o=t.x*a*.5+Math.cos(s)*Math.cos(n)*a,r=Math.sin(n)*a+3,c=t.z*a*.5+Math.sin(s)*Math.cos(n)*a;this.fragments.push({position:{x:this.position.x+(Math.random()-.5)*this.radius,y:this.position.y+(Math.random()-.5)*this.radius,z:this.position.z+(Math.random()-.5)*this.radius},velocity:{x:o,y:r,z:c},size:.15+Math.random()*.25,lifetime:1.5+Math.random()*1,rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-.5)*15})}}canRemove(){return!this.active&&this.removeTimer<=0&&this.fragments.length===0}getShaderData(){let t=0;if(this.active){const e=this.fireIntensity*.5;switch(this.enemyType){case"phantom":t=3+e;break;case"runner":t=5+e;break;case"hopper":t=7+e;break;case"boss_green":t=11+e;break;case"boss_black":t=13+e;break;case"boss_blue":t=15+e;break;default:t=1+e}}return[this.position.x,this.position.y,this.position.z,t]}getFragmentsData(){const t=[];for(const e of this.fragments)t.push(e.position.x,e.position.y,e.position.z,e.size);return t}}class L{targets=[];wave=0;waveActive=!1;waveDelay=4;waveTimer=0;score=0;powerCrystals=[];onTargetDestroyed;onPlayerHit;onWaveComplete;onWaveStart;onPoolDamage;onCrystalDestroyed;onBossPhaseChange;onAcidRain;onBossVortexStart;onBossVortexEnd;onBossVortexWarning;toxicPools=[];acidRainZones=[];greenBossPhase2=!1;acidProjectiles=[];poolDamageTimer=0;collision=null;constructor(t){this.collision=t||null}isPlayerUnderPlatform(t){return this.collision?this.collision.getCeilingHeight(t)<15:!1}startGame(t=1){this.wave=t-1,this.score=0,this.targets=[],this.toxicPools=[],this.greenBossPhase2=!1,this.startNextWave()}startNextWave(){this.wave++,this.waveActive=!0,this.spawnEnemies(this.wave),this.onWaveStart?.(this.wave)}enemyIdCounter=0;spawnEnemies(t){const i=3.5+t*.3;if(t===5){const l=[{pos:T(-8,3,-18),role:"hunter"},{pos:T(8,3,-18),role:"blocker"}];for(const u of l){const p=new M(u.pos,i,this.enemyIdCounter++,"boss_green",this.collision||void 0);p.greenBossRole=u.role,u.role==="hunter"?p.onAcidRainMark=m=>{this.spawnAcidRainZone(m)}:p.onSpit=(m,f)=>{this.spawnAcidProjectile(m,f)},p.onPhaseChange=m=>{this.onBossPhaseChange?.(p.enemyType,m)},this.targets.push(p)}}else if(t===10){const l=T(0,2.5,-18),u=new M(l,i,this.enemyIdCounter++,"boss_black",this.collision||void 0);u.onSpawnPhantom=m=>{this.spawnPhantomFromBoss(m)},u.onVortexWarning=()=>{this.onBossVortexWarning?.()},u.onVortexStart=()=>{this.onBossVortexStart?.()},u.onVortexEnd=()=>{this.onBossVortexEnd?.()},this.targets.push(u);const p=[{x:10,z:0,height:2.3},{x:5,z:8.66,height:3.5},{x:-5,z:8.66,height:4.7},{x:-10,z:0,height:5.9},{x:-5,z:-8.66,height:7.1},{x:5,z:-8.66,height:8.3}];this.powerCrystals=p.map((m,f)=>({x:m.x,z:m.z,height:m.height,active:!0,platformIndex:f}))}else if(t===15){const l=T(0,2,-18);this.targets.push(new M(l,i,this.enemyIdCounter++,"boss_blue",this.collision||void 0))}if(t===5||t===10||t===15)return;let n,a,o,r;t<=5?(n=Math.floor(t*1.2),a=t>=3?Math.floor((t-2)*.8):0,o=0,r=t>=4?Math.floor((t-3)*.5):0):t<=10?(n=Math.floor(t*.8),a=Math.floor((t-3)*.6),o=0,r=Math.floor((t-4)*.6)):(n=Math.floor(t*.7),a=Math.floor((t-5)*.5),o=Math.floor((t-10)*1.5),r=Math.floor((t-6)*.5));const c=Math.max(1,n+a+o+r);let h=0;for(let l=0;l<n;l++){const u=h/c*Math.PI*2+Math.random()*.3,p=1+Math.random()*2.5,m=T(Math.cos(u)*18,p,Math.sin(u)*18),f=i+Math.random()*1.5;this.targets.push(new M(m,f,this.enemyIdCounter++,"baneling",this.collision||void 0)),h++}for(let l=0;l<o;l++){const u=h/c*Math.PI*2+Math.random()*.3,p=T(Math.cos(u)*18,.5,Math.sin(u)*18),m=i+Math.random()*1;this.targets.push(new M(p,m,this.enemyIdCounter++,"runner",this.collision||void 0)),h++}for(let l=0;l<r;l++){const u=h/c*Math.PI*2+Math.random()*.3,p=T(Math.cos(u)*18,.5,Math.sin(u)*18),m=i+Math.random()*1;this.targets.push(new M(p,m,this.enemyIdCounter++,"hopper",this.collision||void 0)),h++}for(let l=0;l<a;l++){const u=(n+l)/c*Math.PI*2+Math.random()*.3,p=1.5+Math.random()*2,m=T(Math.cos(u)*18,p,Math.sin(u)*18),f=i+Math.random()*1;this.targets.push(new M(m,f,this.enemyIdCounter++,"phantom",this.collision||void 0))}}phantomDamageCooldown=new Map;update(t,e,i){if(!this.waveActive&&this.waveTimer>0){this.waveTimer-=t,this.waveTimer<=0&&this.startNextWave();return}for(const[s,n]of this.phantomDamageCooldown)n>0&&this.phantomDamageCooldown.set(s,n-t);for(const s of this.targets)s.update(t,e,i),s.checkPlayerCollision(e)&&(s.enemyType==="phantom"?(this.phantomDamageCooldown.get(s.id)||0)<=0&&(this.onPlayerHit?.(s),this.phantomDamageCooldown.set(s.id,1)):s.isBoss?(this.phantomDamageCooldown.get(s.id)||0)<=0&&(this.onPlayerHit?.(s),this.phantomDamageCooldown.set(s.id,1.5)):(this.onPlayerHit?.(s),s.active=!1));this.targets=this.targets.filter(s=>!s.canRemove());for(const s of this.acidProjectiles){s.progress+=t/s.flightTime;const n=s.progress;s.position.x=s.startPos.x+(s.targetPos.x-s.startPos.x)*n,s.position.z=s.startPos.z+(s.targetPos.z-s.startPos.z)*n,s.position.y=s.startPos.y+(1-(2*n-1)*(2*n-1))*8,s.progress>=1&&(this.toxicPools.push({position:{...s.targetPos},radius:.5,maxRadius:3.5,lifetime:6,maxLifetime:6,damage:8,spreadProgress:0}),this.onAcidRain?.(s.targetPos))}this.acidProjectiles=this.acidProjectiles.filter(s=>s.progress<1);for(const s of this.toxicPools)s.spreadProgress<1&&(s.spreadProgress=Math.min(1,s.spreadProgress+t/1.5),s.radius=s.maxRadius*(.3+.7*s.spreadProgress));for(const s of this.acidRainZones)s.isRaining?s.lifetime-=t:(s.markTime-=t,s.markTime<=0&&(s.isRaining=!0,this.onAcidRainStart?.(s.position)));if(this.acidRainZones=this.acidRainZones.filter(s=>s.lifetime>0||!s.isRaining),this.poolDamageTimer-=t,this.poolDamageTimer<=0){this.poolDamageTimer=.5;for(const s of this.toxicPools){const n=e.x-s.position.x,a=e.z-s.position.z;if(Math.sqrt(n*n+a*a)<s.radius&&e.y<.8){this.onPoolDamage?.(s.damage);break}}for(const s of this.acidRainZones){if(!s.isRaining)continue;const n=e.x-s.position.x,a=e.z-s.position.z;if(Math.sqrt(n*n+a*a)<s.radius&&!this.isPlayerUnderPlatform(e)){this.onPoolDamage?.(s.damage);break}}}this.waveActive&&this.getActiveCount()===0&&(this.waveActive=!1,this.waveTimer=this.waveDelay,this.onWaveComplete?.(this.wave))}trySlice(t,e,i,s){for(const n of this.targets){if(!n.active)continue;const a=n.position.x-t.x,o=n.position.z-t.z,r=Math.sqrt(a*a+o*o),c=i+(n.isBoss?n.radius:0);if(r>c)continue;let l=Math.atan2(a,-o)-e;for(;l>Math.PI;)l-=Math.PI*2;for(;l<-Math.PI;)l+=Math.PI*2;if(!(Math.abs(l)>s/2))if(n.isBoss){const u=n.takeDamage(1);if(n.enemyType==="boss_green"&&!u){const p=this.greenBossPhase2?2:1;for(let m=0;m<p;m++)this.spawnBanelingFromBoss(n.position)}if(u){const p=V({x:a,y:0,z:o});if(n.slice(p),this.score+=1e3*this.wave,this.onTargetDestroyed?.(n),n.enemyType==="boss_green"){this.targets.filter(f=>f.active&&f.enemyType==="boss_green"&&f!==n).length>0&&!this.greenBossPhase2&&(this.greenBossPhase2=!0,this.onBossPhaseChange?.("boss_green",2));for(let f=0;f<5;f++)this.spawnBanelingFromBoss(n.position)}}else{const p=n.enemyType==="boss_green"?8:n.enemyType==="boss_black"?5:12;n.applyKnockback(a,o,p)}return n}else{const u=V({x:a,y:0,z:o});return n.slice(u),this.score+=100*this.wave,this.onTargetDestroyed?.(n),n}}return null}trySplashWave(t,e,i){let s=0;for(const n of this.targets){if(!n.active)continue;const a=n.position.x-t.x,o=n.position.z-t.z,r=Math.sqrt(a*a+o*o),c=i+(n.isBoss,n.radius);if(!(r>c))if(n.isBoss){const h=n.takeDamage(2);if(n.enemyType==="boss_green"&&!h){const l=this.greenBossPhase2?2:1;for(let u=0;u<l;u++)this.spawnBanelingFromBoss(n.position)}if(h){const l=V({x:a,y:0,z:o});if(n.slice(l),this.score+=1e3*this.wave,this.onTargetDestroyed?.(n),s++,n.enemyType==="boss_green"){this.targets.filter(p=>p.active&&p.enemyType==="boss_green"&&p!==n).length>0&&!this.greenBossPhase2&&(this.greenBossPhase2=!0,this.onBossPhaseChange?.("boss_green",2));for(let p=0;p<5;p++)this.spawnBanelingFromBoss(n.position)}}else{const l=n.enemyType==="boss_green"?12:n.enemyType==="boss_black"?8:18;n.applyKnockback(a,o,l)}}else{const h=V({x:a,y:0,z:o});n.slice(h),this.score+=100*this.wave,this.onTargetDestroyed?.(n),s++}}return s}getShaderData(){const t=new Float32Array(this.targets.length*4);for(let e=0;e<this.targets.length;e++){const[i,s,n,a]=this.targets[e].getShaderData();t[e*4+0]=i,t[e*4+1]=s,t[e*4+2]=n,t[e*4+3]=a}return t}getAllFragmentsData(){const t=[];for(const e of this.targets)t.push(...e.getFragmentsData());return new Float32Array(t)}getPoolsShaderData(){const t=new Float32Array(this.toxicPools.length*4);for(let e=0;e<this.toxicPools.length;e++){const i=this.toxicPools[e];t[e*4+0]=i.position.x,t[e*4+1]=i.position.z,t[e*4+2]=i.radius,t[e*4+3]=i.spreadProgress}return t}getAcidProjectilesData(){const t=new Float32Array(this.acidProjectiles.length*4);for(let e=0;e<this.acidProjectiles.length;e++){const i=this.acidProjectiles[e];t[e*4+0]=i.position.x,t[e*4+1]=i.position.y,t[e*4+2]=i.position.z,t[e*4+3]=i.progress}return t}getAcidRainZonesData(){const t=new Float32Array(this.acidRainZones.length*4);for(let e=0;e<this.acidRainZones.length;e++){const i=this.acidRainZones[e];t[e*4+0]=i.position.x,t[e*4+1]=i.position.z,t[e*4+2]=i.radius,t[e*4+3]=i.isRaining?1:(1-i.markTime/1.5)*.5}return t}spawnAcidProjectile(t,e){this.acidProjectiles.push({position:{...t},targetPos:{...e},startPos:{...t},progress:0,flightTime:1.2}),this.onAcidSpit?.()}spawnAcidRainZone(t){this.acidRainZones.push({position:{...t},radius:4,lifetime:5,markTime:1.5,isRaining:!1,damage:6}),this.onAcidRainMarkSound?.()}onAcidSpit;onAcidRainMarkSound;onAcidRainStart;spawnBanelingFromBoss(t){const e=Math.random()*Math.PI*2,i=5+Math.random()*3,s=T(t.x+Math.cos(e)*2,t.y+Math.random()*1.5,t.z+Math.sin(e)*2),n=new M(s,i,this.enemyIdCounter++,"baneling",this.collision||void 0);n.velocity=T(Math.cos(e)*8,3+Math.random()*3,Math.sin(e)*8),this.targets.push(n)}spawnPhantomFromBoss(t){const e=8+Math.random()*4,i=new M(t,e,this.enemyIdCounter++,"phantom",this.collision||void 0);this.targets.push(i)}getVortexPull(t){for(const e of this.targets)if(e.active&&e.enemyType==="boss_black")return e.getVortexPull(t);return T(0,0,0)}trySliceCrystal(t,e,i){for(const s of this.powerCrystals){if(!s.active)continue;const n=s.x-t.x,a=s.height-t.y,o=s.z-t.z;if(Math.sqrt(n*n+a*a+o*o)>i+1)continue;let h=Math.atan2(n,-o)-e;for(;h>Math.PI;)h-=Math.PI*2;for(;h<-Math.PI;)h+=Math.PI*2;if(Math.abs(h)>Math.PI/3)continue;s.active=!1;const l=this.powerCrystals.filter(u=>u.active).length;this.onCrystalDestroyed?.(l),this.spawnPhantomFromBoss(T(s.x,s.height,s.z));for(const u of this.targets)u.active&&u.enemyType==="boss_black"&&(u.maxHp-=10,u.hp>u.maxHp&&(u.hp=u.maxHp));return!0}return!1}getCrystalsData(){const t=new Float32Array(24);for(let e=0;e<6;e++)if(e<this.powerCrystals.length){const i=this.powerCrystals[e];t[e*4+0]=i.x,t[e*4+1]=i.z,t[e*4+2]=i.height,t[e*4+3]=i.active?1:0}else t[e*4+3]=0;return t}getActiveCount(){return this.targets.filter(t=>t.active).length}getActiveBoss(){return this.targets.find(t=>t.active&&t.isBoss)||null}getClosestEnemyDistance(t){let e=1/0;for(const i of this.targets){if(!i.active)continue;const s=i.position.x-t.x,n=i.position.y-t.y,a=i.position.z-t.z,o=Math.sqrt(s*s+n*n+a*a);o<e&&(e=o)}return e}createArenaTargets(t=8){this.startGame()}checkProjectileHit(t,e){return null}}class P{position;type;radius=1;active=!0;lifetime;phase;baseY;constructor(t,e){this.position={...t},this.type=e,this.phase=Math.random()*Math.PI*2,this.baseY=t.y,this.lifetime=30}update(t,e){this.active&&(this.position.y=this.baseY+Math.sin(e*3+this.phase)*.2,this.lifetime-=t,this.lifetime<=0&&(this.active=!1))}checkPickup(t){return this.active&&z(this.position,t)<this.radius+.5?(this.active=!1,!0):!1}getShaderData(){let t=0;return this.active&&(this.type==="health"?t=9:this.type==="stimpack"?t=10:this.type==="charge"&&(t=11)),[this.position.x,this.position.y,this.position.z,t]}}class H{pickups=[];spawnTimer=10;platformSpawnTimer=30;platformPositions=[{x:-20,y:2.5,z:0},{x:20,y:2.5,z:0}];currentPlatform=0;maxPickups=5;chargeOnBalcony=null;chargeRespawnTimer=0;constructor(){this.spawnChargeOnBalcony()}update(t,e,i){for(const s of this.pickups)s.update(t,e);if(this.pickups=this.pickups.filter(s=>s.active),this.spawnTimer-=t,this.spawnTimer<=0&&this.pickups.length<this.maxPickups&&(this.spawnRandom(),this.spawnTimer=8+Math.random()*7),this.platformSpawnTimer-=t,this.platformSpawnTimer<=0&&(this.spawnOnPlatform(),this.platformSpawnTimer=30),this.updateChargeRespawn(t),this.checkChargePickup(i))return"charge";for(const s of this.pickups)if(s.type!=="charge"&&s.checkPickup(i))return s.type;return null}spawnRandom(){const e=Math.random()*Math.PI*2,i=5+Math.random()*15,s=T(Math.cos(e)*i,1,Math.sin(e)*i);this.pickups.push(new P(s,"health"))}spawnOnPlatform(){const t=this.platformPositions[this.currentPlatform];this.currentPlatform=(this.currentPlatform+1)%this.platformPositions.length;const e=T(t.x+(Math.random()-.5)*4,t.y,t.z+(Math.random()-.5)*8);this.pickups.push(new P(e,"health"))}spawnAfterKill(t){if(Math.random()<.25){const e=T(t.x+(Math.random()-.5)*2,1,t.z+(Math.random()-.5)*2);this.pickups.push(new P(e,"health"))}}spawnChargeOnBalcony(){const t=T(0,10.3,0);this.chargeOnBalcony=new P(t,"charge"),this.chargeOnBalcony.lifetime=999999,this.pickups.push(this.chargeOnBalcony)}checkChargePickup(t){return!this.chargeOnBalcony||!this.chargeOnBalcony.active||t.y<10.5?!1:this.chargeOnBalcony.checkPickup(t)?(this.chargeOnBalcony=null,this.chargeRespawnTimer=60,!0):!1}respawnChargeAfterBoss(){(!this.chargeOnBalcony||!this.chargeOnBalcony.active)&&(this.pickups=this.pickups.filter(t=>t!==this.chargeOnBalcony),this.chargeOnBalcony=null,this.chargeRespawnTimer=0,this.spawnChargeOnBalcony())}updateChargeRespawn(t){this.chargeOnBalcony===null&&this.chargeRespawnTimer>0&&(this.chargeRespawnTimer-=t,this.chargeRespawnTimer<=0&&this.spawnChargeOnBalcony())}getShaderData(){const t=new Float32Array(this.pickups.length*4);for(let e=0;e<this.pickups.length;e++){const[i,s,n,a]=this.pickups[e].getShaderData();t[e*4+0]=i,t[e*4+1]=s,t[e*4+2]=n,t[e*4+3]=a}return t}}class W{ctx=null;masterGain=null;musicGain=null;sfxGain=null;reverb=null;distortion=null;compressor=null;isStarted=!1;isMuted=!1;start(){this.isStarted||(this.ctx=new(window.AudioContext||window.webkitAudioContext),this.compressor=this.ctx.createDynamicsCompressor(),this.compressor.threshold.value=-24,this.compressor.knee.value=30,this.compressor.ratio.value=12,this.compressor.attack.value=.003,this.compressor.release.value=.25,this.compressor.connect(this.ctx.destination),this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=.4,this.masterGain.connect(this.compressor),this.distortion=this.createDistortion(20),this.distortion.connect(this.masterGain),this.reverb=this.createReverb(2.5),this.reverb.connect(this.masterGain),this.musicGain=this.ctx.createGain(),this.musicGain.gain.value=.12,this.musicGain.connect(this.masterGain),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=.3,this.sfxGain.connect(this.distortion),this.isStarted=!0,this.startSynthwaveMusic())}createDistortion(t){const e=this.ctx.createWaveShaper(),i=44100,s=new Float32Array(i),n=Math.PI/180;for(let a=0;a<i;a++){const o=a*2/i-1;s[a]=(3+t)*o*20*n/(Math.PI+t*Math.abs(o))}return e.curve=s,e.oversample="4x",e}createReverb(t){const e=this.ctx.createConvolver(),i=this.ctx.sampleRate,s=i*t,n=this.ctx.createBuffer(2,s,i);for(let a=0;a<2;a++){const o=n.getChannelData(a);for(let r=0;r<s;r++){const c=Math.exp(-3*r/s),h=Math.sin(r*.001)*.3+.7;o[r]=(Math.random()*2-1)*c*h}}return e.buffer=n,e}toggleMute(){this.isMuted=!this.isMuted,this.masterGain&&(this.masterGain.gain.value=this.isMuted?0:this.volume)}volume=.5;setVolume(t){this.volume=Math.max(0,Math.min(1,t)),this.masterGain&&!this.isMuted&&(this.masterGain.gain.value=this.volume)}proximityOsc=null;proximityGain=null;proximityFilter=null;playSFX(t){if(!(!this.ctx||!this.sfxGain||this.isMuted))switch(t){case"gunshot":this.playKatanaSwing();break;case"reload":this.playGlitch();break;case"footstep":this.playFootstep();break;case"jump":this.playJump();break;case"land":this.playLand();break;case"hit":this.playBanelingExplosion();break;case"phantom_pass":this.playPhantomPass();break;case"runner_hit":this.playRunnerHit();break;case"hopper_hit":this.playHopperHit();break;case"kill":this.playKill();break;case"katana_swing":this.playKatanaSwing();break;case"splash_wave":this.playSplashWave();break;case"charge_pickup":this.playChargePickup();break;case"acid_spit":this.playAcidSpit();break}}updateProximitySound(t){if(!this.ctx||!this.sfxGain||this.isMuted)return;this.proximityOsc||(this.proximityOsc=this.ctx.createOscillator(),this.proximityGain=this.ctx.createGain(),this.proximityFilter=this.ctx.createBiquadFilter(),this.proximityOsc.type="sawtooth",this.proximityFilter.type="lowpass",this.proximityFilter.Q.value=5,this.proximityOsc.connect(this.proximityFilter),this.proximityFilter.connect(this.proximityGain),this.proximityGain.connect(this.sfxGain),this.proximityOsc.start());const e=80+t*200,i=t*.25,s=200+t*1500;if(this.proximityOsc.frequency.setTargetAtTime(e,this.ctx.currentTime,.1),this.proximityGain.gain.setTargetAtTime(i,this.ctx.currentTime,.1),this.proximityFilter.frequency.setTargetAtTime(s,this.ctx.currentTime,.1),t>.6){const n=Math.sin(this.ctx.currentTime*20)*20*t;this.proximityOsc.frequency.setTargetAtTime(e+n,this.ctx.currentTime,.02)}}enemySoundCooldowns=new Map;playEnemyProximitySound(t,e){if(!this.ctx||!this.sfxGain||this.isMuted||e>8)return;const i=Date.now(),s=this.enemySoundCooldowns.get(t)||0,n=t.startsWith("boss")?500:300;if(i-s<n)return;this.enemySoundCooldowns.set(t,i);const a=Math.max(.1,(8-e)/8)*.4,o=this.ctx.currentTime;switch(t){case"baneling":this.playBanelingProximity(a,o);break;case"phantom":this.playPhantomProximity(a,o);break;case"runner":this.playRunnerProximity(a,o);break;case"hopper":this.playHopperProximity(a,o);break;case"boss_green":this.playBossGreenProximity(a,o);break;case"boss_black":this.playBossBlackProximity(a,o);break;case"boss_blue":this.playBossBlueProximity(a,o);break}}playBanelingProximity(t,e){if(!this.ctx||!this.sfxGain)return;const i=this.ctx.createOscillator(),s=this.ctx.createGain(),n=this.ctx.createBiquadFilter();i.type="sine",i.frequency.setValueAtTime(150+Math.random()*50,e),i.frequency.setValueAtTime(100+Math.random()*30,e+.05),i.frequency.setValueAtTime(180+Math.random()*40,e+.1),n.type="lowpass",n.frequency.value=400,n.Q.value=8,s.gain.setValueAtTime(t*.5,e),s.gain.exponentialRampToValueAtTime(.01,e+.15),i.connect(n),n.connect(s),s.connect(this.sfxGain),i.start(e),i.stop(e+.2)}playPhantomProximity(t,e){if(!this.ctx||!this.sfxGain)return;const i=this.ctx.createOscillator(),s=this.ctx.createOscillator(),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();i.type="sine",i.frequency.setValueAtTime(200,e),i.frequency.linearRampToValueAtTime(150,e+.3),s.type="sine",s.frequency.setValueAtTime(203,e),s.frequency.linearRampToValueAtTime(148,e+.3),a.type="bandpass",a.frequency.value=300,a.Q.value=5,n.gain.setValueAtTime(0,e),n.gain.linearRampToValueAtTime(t*.4,e+.1),n.gain.linearRampToValueAtTime(0,e+.35),i.connect(a),s.connect(a),a.connect(n),n.connect(this.sfxGain),i.start(e),i.stop(e+.4),s.start(e),s.stop(e+.4)}playRunnerProximity(t,e){if(!(!this.ctx||!this.sfxGain))for(let i=0;i<3;i++){const s=this.ctx.createOscillator(),n=this.ctx.createGain(),a=e+i*.06;s.type="triangle",s.frequency.setValueAtTime(80+Math.random()*40,a),s.frequency.exponentialRampToValueAtTime(40,a+.03),n.gain.setValueAtTime(t*.3,a),n.gain.exponentialRampToValueAtTime(.01,a+.04),s.connect(n),n.connect(this.sfxGain),s.start(a),s.stop(a+.05)}}playHopperProximity(t,e){if(!this.ctx||!this.sfxGain)return;const i=this.ctx.createOscillator(),s=this.ctx.createGain();i.type="sine",i.frequency.setValueAtTime(100,e),i.frequency.exponentialRampToValueAtTime(400,e+.1),i.frequency.exponentialRampToValueAtTime(150,e+.2),s.gain.setValueAtTime(t*.4,e),s.gain.exponentialRampToValueAtTime(.01,e+.25),i.connect(s),s.connect(this.sfxGain),i.start(e),i.stop(e+.3)}playBossGreenProximity(t,e){if(!this.ctx||!this.sfxGain)return;const i=this.ctx.sampleRate*.5,s=this.ctx.createBuffer(1,i,this.ctx.sampleRate),n=s.getChannelData(0);for(let m=0;m<i;m++){const f=m/this.ctx.sampleRate,d=Math.sin(f*12)*.5+.5,y=Math.sin(f*Math.PI/.5)*d;n[m]=(Math.random()*2-1)*y*.8}const a=this.ctx.createBufferSource();a.buffer=s;const o=this.ctx.createBiquadFilter();o.type="bandpass",o.frequency.value=3500,o.Q.value=1.5;const r=this.ctx.createBiquadFilter();r.type="highpass",r.frequency.value=800;const c=this.ctx.createGain();c.gain.setValueAtTime(0,e),c.gain.linearRampToValueAtTime(t*.6,e+.05),c.gain.setValueAtTime(t*.6,e+.35),c.gain.exponentialRampToValueAtTime(.01,e+.5),a.connect(o),o.connect(r),r.connect(c),c.connect(this.sfxGain),a.start(e),a.stop(e+.55);const h=this.ctx.createOscillator(),l=this.ctx.createOscillator(),u=this.ctx.createGain(),p=this.ctx.createBiquadFilter();if(h.type="sine",h.frequency.value=85,l.type="sine",l.frequency.value=87,p.type="lowpass",p.frequency.value=150,u.gain.setValueAtTime(t*.15,e),u.gain.exponentialRampToValueAtTime(.01,e+.5),h.connect(p),l.connect(p),p.connect(u),u.connect(this.sfxGain),h.start(e),l.start(e),h.stop(e+.55),l.stop(e+.55),Math.random()>.5){const m=this.ctx.createOscillator(),f=this.ctx.createGain();m.type="sine",m.frequency.setValueAtTime(300,e+.1),m.frequency.exponentialRampToValueAtTime(150,e+.4),f.gain.setValueAtTime(t*.08,e+.1),f.gain.exponentialRampToValueAtTime(.01,e+.4),m.connect(f),f.connect(this.sfxGain),m.start(e+.1),m.stop(e+.45)}}playBossBlackProximity(t,e){if(!this.ctx||!this.sfxGain)return;const i=this.ctx.createOscillator(),s=this.ctx.createOscillator(),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();i.type="sine",i.frequency.setValueAtTime(40,e),s.type="sine",s.frequency.setValueAtTime(42,e),a.type="lowpass",a.frequency.value=100,a.Q.value=10,n.gain.setValueAtTime(0,e),n.gain.linearRampToValueAtTime(t*.6,e+.15),n.gain.linearRampToValueAtTime(0,e+.4),i.connect(a),s.connect(a),a.connect(n),n.connect(this.sfxGain),i.start(e),i.stop(e+.45),s.start(e),s.stop(e+.45);const o=this.ctx.createOscillator(),r=this.ctx.createGain();o.type="sawtooth",o.frequency.setValueAtTime(80,e),o.frequency.exponentialRampToValueAtTime(30,e+.3),r.gain.setValueAtTime(t*.2,e),r.gain.exponentialRampToValueAtTime(.01,e+.35),o.connect(r),r.connect(this.sfxGain),o.start(e),o.stop(e+.4)}playBossBlueProximity(t,e){if(!this.ctx||!this.sfxGain)return;const i=this.ctx.sampleRate*.15,s=this.ctx.createBuffer(1,i,this.ctx.sampleRate),n=s.getChannelData(0);for(let l=0;l<i;l++)n[l]=Math.random()>.95?Math.random()*2-1:0;const a=this.ctx.createBufferSource();a.buffer=s;const o=this.ctx.createBiquadFilter();o.type="highpass",o.frequency.value=3e3;const r=this.ctx.createGain();r.gain.setValueAtTime(t*.4,e),r.gain.exponentialRampToValueAtTime(.01,e+.15),a.connect(o),o.connect(r),r.connect(this.sfxGain),a.start(e),a.stop(e+.18);const c=this.ctx.createOscillator(),h=this.ctx.createGain();c.type="sine",c.frequency.setValueAtTime(2e3+Math.random()*500,e),c.frequency.exponentialRampToValueAtTime(500,e+.1),h.gain.setValueAtTime(t*.25,e),h.gain.exponentialRampToValueAtTime(.01,e+.12),c.connect(h),h.connect(this.sfxGain),c.start(e),c.stop(e+.15)}playBanelingExplosion(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sine",e.frequency.setValueAtTime(100,t),e.frequency.exponentialRampToValueAtTime(20,t+.3),i.gain.setValueAtTime(.7,t),i.gain.exponentialRampToValueAtTime(.01,t+.4),e.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+.5);const s=this.createNoise(.4),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter(),o=this.ctx.createBiquadFilter();a.type="bandpass",a.frequency.setValueAtTime(3e3,t),a.frequency.exponentialRampToValueAtTime(500,t+.3),a.Q.value=3,o.type="highpass",o.frequency.value=1e3,n.gain.setValueAtTime(.5,t),n.gain.exponentialRampToValueAtTime(.01,t+.35),s.connect(a),a.connect(o),o.connect(n),n.connect(this.sfxGain);for(let l=0;l<5;l++){const u=l*.04,p=this.ctx.createOscillator(),m=this.ctx.createGain();p.type="sine",p.frequency.setValueAtTime(400+Math.random()*600,t+u),p.frequency.exponentialRampToValueAtTime(100+Math.random()*100,t+u+.08),m.gain.setValueAtTime(.15,t+u),m.gain.exponentialRampToValueAtTime(.01,t+u+.1),p.connect(m),m.connect(this.sfxGain),p.start(t+u),p.stop(t+u+.15)}const r=this.createNoise(.8),c=this.ctx.createGain(),h=this.ctx.createBiquadFilter();h.type="highpass",h.frequency.value=4e3,c.gain.setValueAtTime(.2,t+.1),c.gain.exponentialRampToValueAtTime(.01,t+.7),r.connect(h),h.connect(c),c.connect(this.sfxGain)}playPhantomPass(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();e.type="sawtooth",e.frequency.setValueAtTime(400,t),e.frequency.exponentialRampToValueAtTime(100,t+.3),s.type="lowpass",s.frequency.setValueAtTime(2e3,t),s.frequency.exponentialRampToValueAtTime(300,t+.3),s.Q.value=2,i.gain.setValueAtTime(.3,t),i.gain.exponentialRampToValueAtTime(.01,t+.4),e.connect(s),s.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+.5);const n=this.ctx.createOscillator(),a=this.ctx.createGain();n.type="sine",n.frequency.setValueAtTime(60,t),n.frequency.exponentialRampToValueAtTime(30,t+.5),a.gain.setValueAtTime(.4,t),a.gain.exponentialRampToValueAtTime(.01,t+.6),n.connect(a),a.connect(this.sfxGain),n.start(t),n.stop(t+.7);const o=this.createNoise(.3),r=this.ctx.createGain(),c=this.ctx.createBiquadFilter();c.type="bandpass",c.frequency.value=3e3,c.Q.value=5,r.gain.setValueAtTime(.15,t),r.gain.exponentialRampToValueAtTime(.01,t+.25),o.connect(c),c.connect(r),r.connect(this.sfxGain)}playRunnerHit(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sawtooth",e.frequency.setValueAtTime(800,t),e.frequency.exponentialRampToValueAtTime(200,t+.15),i.gain.setValueAtTime(.3,t),i.gain.exponentialRampToValueAtTime(.01,t+.2),e.connect(i),i.connect(this.sfxGain),e.start(t),e.stop(t+.25);for(let a=0;a<4;a++){const o=this.ctx.createOscillator(),r=this.ctx.createGain();o.type="square",o.frequency.value=1e3+Math.random()*2e3;const c=t+a*.03;r.gain.setValueAtTime(.15,c),r.gain.setValueAtTime(0,c+.02),o.connect(r),r.connect(this.sfxGain),o.start(c),o.stop(c+.03)}const s=this.ctx.createOscillator(),n=this.ctx.createGain();s.type="sine",s.frequency.setValueAtTime(120,t),s.frequency.exponentialRampToValueAtTime(40,t+.15),n.gain.setValueAtTime(.4,t),n.gain.exponentialRampToValueAtTime(.01,t+.2),s.connect(n),n.connect(this.sfxGain),s.start(t),s.stop(t+.25)}playHopperHit(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();e.type="sawtooth",e.frequency.setValueAtTime(2e3,t),e.frequency.exponentialRampToValueAtTime(100,t+.2),s.type="bandpass",s.frequency.value=1500,s.Q.value=3,i.gain.setValueAtTime(.35,t),i.gain.exponentialRampToValueAtTime(.01,t+.25),e.connect(s),s.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+.3);const n=this.ctx.createOscillator(),a=this.ctx.createGain();n.type="sine",n.frequency.setValueAtTime(80,t+.05),n.frequency.exponentialRampToValueAtTime(25,t+.3),a.gain.setValueAtTime(.5,t+.05),a.gain.exponentialRampToValueAtTime(.01,t+.35),n.connect(a),a.connect(this.sfxGain),n.start(t+.05),n.stop(t+.4);const o=this.createNoise(.25),r=this.ctx.createGain(),c=this.ctx.createBiquadFilter();c.type="highpass",c.frequency.value=3e3,r.gain.setValueAtTime(.2,t),r.gain.exponentialRampToValueAtTime(.01,t+.15),o.connect(c),c.connect(r),r.connect(this.sfxGain)}playGlitch(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime;for(let e=0;e<5;e++){const i=e*.03+Math.random()*.02,s=this.ctx.createOscillator(),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();s.type=Math.random()>.5?"square":"sawtooth",s.frequency.value=100+Math.random()*2e3,a.type="bandpass",a.frequency.value=500+Math.random()*3e3,a.Q.value=5+Math.random()*10,n.gain.setValueAtTime(.15,t+i),n.gain.setValueAtTime(0,t+i+.02+Math.random()*.03),s.connect(a),a.connect(n),n.connect(this.sfxGain),n.connect(this.reverb),s.start(t+i),s.stop(t+i+.1)}}playFootstep(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sine",e.frequency.setValueAtTime(80,t),e.frequency.exponentialRampToValueAtTime(30,t+.08),i.gain.setValueAtTime(.2,t),i.gain.exponentialRampToValueAtTime(.01,t+.1),e.connect(i),i.connect(this.sfxGain),e.start(t),e.stop(t+.12);const s=this.createNoise(.06),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();a.type="lowpass",a.frequency.value=300+Math.random()*200,n.gain.setValueAtTime(.1,t),n.gain.exponentialRampToValueAtTime(.01,t+.05),s.connect(a),a.connect(n),n.connect(this.sfxGain)}playJump(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createOscillator(),s=this.ctx.createGain();e.type="square",e.frequency.setValueAtTime(150,t),e.frequency.exponentialRampToValueAtTime(600,t+.1),i.type="sawtooth",i.frequency.setValueAtTime(155,t),i.frequency.exponentialRampToValueAtTime(605,t+.1),s.gain.setValueAtTime(.15,t),s.gain.exponentialRampToValueAtTime(.01,t+.15),e.connect(s),i.connect(s),s.connect(this.sfxGain),s.connect(this.reverb),e.start(t),e.stop(t+.15),i.start(t),i.stop(t+.15)}playLand(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sine",e.frequency.setValueAtTime(100,t),e.frequency.exponentialRampToValueAtTime(20,t+.15),i.gain.setValueAtTime(.5,t),i.gain.exponentialRampToValueAtTime(.01,t+.2),e.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+.25);const s=this.createNoise(.15),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();a.type="lowpass",a.frequency.value=400,n.gain.setValueAtTime(.3,t),n.gain.exponentialRampToValueAtTime(.01,t+.1),s.connect(a),a.connect(n),n.connect(this.sfxGain)}playKill(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sine",e.frequency.setValueAtTime(150,t),e.frequency.exponentialRampToValueAtTime(20,t+.4),i.gain.setValueAtTime(.6,t),i.gain.exponentialRampToValueAtTime(.01,t+.5),e.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+.6);const s=this.ctx.createOscillator(),n=this.ctx.createOscillator(),a=this.ctx.createGain(),o=this.ctx.createBiquadFilter();s.type="sawtooth",s.frequency.setValueAtTime(200,t),s.frequency.exponentialRampToValueAtTime(800,t+.2),n.type="square",n.frequency.setValueAtTime(203,t),n.frequency.exponentialRampToValueAtTime(806,t+.2),o.type="lowpass",o.frequency.setValueAtTime(500,t),o.frequency.exponentialRampToValueAtTime(4e3,t+.15),o.Q.value=3,a.gain.setValueAtTime(.25,t),a.gain.exponentialRampToValueAtTime(.01,t+.3),s.connect(o),n.connect(o),o.connect(a),a.connect(this.sfxGain),a.connect(this.reverb),s.start(t),s.stop(t+.35),n.start(t),n.stop(t+.35);for(let l=0;l<4;l++){const u=.1+l*.05,p=this.ctx.createOscillator(),m=this.ctx.createGain();p.type="square",p.frequency.value=400+Math.random()*1e3,m.gain.setValueAtTime(.1,t+u),m.gain.exponentialRampToValueAtTime(.01,t+u+.03),p.connect(m),m.connect(this.distortion),p.start(t+u),p.stop(t+u+.05)}const r=this.createNoise(.3),c=this.ctx.createGain(),h=this.ctx.createBiquadFilter();h.type="bandpass",h.frequency.setValueAtTime(2e3,t),h.frequency.exponentialRampToValueAtTime(200,t+.3),h.Q.value=1,c.gain.setValueAtTime(.3,t),c.gain.exponentialRampToValueAtTime(.01,t+.25),r.connect(h),h.connect(c),c.connect(this.sfxGain)}createNoise(t){if(!this.ctx)throw new Error("AudioContext not initialized");const e=this.ctx.sampleRate*t,i=this.ctx.createBuffer(1,e,this.ctx.sampleRate),s=i.getChannelData(0);for(let a=0;a<e;a++)s[a]=Math.random()*2-1;const n=this.ctx.createBufferSource();return n.buffer=i,n.start(),n}playKatanaSwing(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();e.type="sawtooth",e.frequency.setValueAtTime(600,t),e.frequency.exponentialRampToValueAtTime(100,t+.12),s.type="bandpass",s.frequency.setValueAtTime(800,t),s.frequency.exponentialRampToValueAtTime(300,t+.12),s.Q.value=4,i.gain.setValueAtTime(.25,t),i.gain.exponentialRampToValueAtTime(.01,t+.15),e.connect(s),s.connect(i),i.connect(this.sfxGain),e.start(t),e.stop(t+.2);const n=this.ctx.createOscillator(),a=this.ctx.createGain();n.type="sine",n.frequency.value=1800,a.gain.setValueAtTime(.08,t+.03),a.gain.exponentialRampToValueAtTime(.01,t+.1),n.connect(a),a.connect(this.sfxGain),n.start(t+.03),n.stop(t+.15)}playSplashWave(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();e.type="sawtooth",e.frequency.setValueAtTime(200,t),e.frequency.exponentialRampToValueAtTime(80,t+.4),s.type="lowpass",s.frequency.setValueAtTime(2e3,t),s.frequency.exponentialRampToValueAtTime(400,t+.4),s.Q.value=10,i.gain.setValueAtTime(.5,t),i.gain.exponentialRampToValueAtTime(.01,t+.5),e.connect(s),s.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+.5);const n=this.createNoise(.3),a=this.ctx.createGain(),o=this.ctx.createBiquadFilter();o.type="bandpass",o.frequency.value=3e3,o.Q.value=5,a.gain.setValueAtTime(.2,t),a.gain.exponentialRampToValueAtTime(.01,t+.25),n.connect(o),o.connect(a),a.connect(this.sfxGain);const r=this.ctx.createOscillator(),c=this.ctx.createGain();r.type="sine",r.frequency.setValueAtTime(800,t),r.frequency.exponentialRampToValueAtTime(400,t+.3),c.gain.setValueAtTime(.15,t),c.gain.exponentialRampToValueAtTime(.01,t+.35),r.connect(c),c.connect(this.sfxGain),r.start(t),r.stop(t+.4);const h=this.ctx.createOscillator(),l=this.ctx.createGain();h.type="sine",h.frequency.setValueAtTime(60,t),h.frequency.exponentialRampToValueAtTime(30,t+.3),l.gain.setValueAtTime(.6,t),l.gain.exponentialRampToValueAtTime(.01,t+.4),h.connect(l),l.connect(this.sfxGain),h.start(t),h.stop(t+.45)}playChargePickup(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createOscillator(),s=this.ctx.createGain(),n=this.ctx.createBiquadFilter();e.type="sawtooth",e.frequency.setValueAtTime(150,t),e.frequency.exponentialRampToValueAtTime(800,t+.3),i.type="square",i.frequency.setValueAtTime(152,t),i.frequency.exponentialRampToValueAtTime(810,t+.3),n.type="bandpass",n.frequency.setValueAtTime(500,t),n.frequency.exponentialRampToValueAtTime(2e3,t+.3),n.Q.value=8,s.gain.setValueAtTime(.15,t),s.gain.linearRampToValueAtTime(.35,t+.2),s.gain.exponentialRampToValueAtTime(.01,t+.5),e.connect(n),i.connect(n),n.connect(s),s.connect(this.sfxGain),s.connect(this.reverb),e.start(t),e.stop(t+.5),i.start(t),i.stop(t+.5);const a=this.ctx.createOscillator(),o=this.ctx.createGain();a.type="sine",a.frequency.value=2500,o.gain.setValueAtTime(.12,t+.15),o.gain.exponentialRampToValueAtTime(.01,t+.5),a.connect(o),o.connect(this.reverb),a.start(t+.15),a.stop(t+.55);const r=this.createNoise(.2),c=this.ctx.createGain(),h=this.ctx.createBiquadFilter();h.type="highpass",h.frequency.value=4e3,c.gain.setValueAtTime(.1,t+.1),c.gain.exponentialRampToValueAtTime(.01,t+.3),r.connect(h),h.connect(c),c.connect(this.sfxGain)}playAcidSpit(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sawtooth",e.frequency.setValueAtTime(150,t),e.frequency.exponentialRampToValueAtTime(80,t+.15),i.gain.setValueAtTime(.25,t),i.gain.exponentialRampToValueAtTime(.01,t+.2),e.connect(i),i.connect(this.sfxGain),e.start(t),e.stop(t+.2);const s=this.ctx.createOscillator(),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();s.type="sawtooth",s.frequency.setValueAtTime(500,t+.1),s.frequency.exponentialRampToValueAtTime(150,t+1.2),a.type="bandpass",a.frequency.setValueAtTime(400,t),a.frequency.exponentialRampToValueAtTime(200,t+1),a.Q.value=3,n.gain.setValueAtTime(0,t),n.gain.linearRampToValueAtTime(.15,t+.1),n.gain.exponentialRampToValueAtTime(.01,t+1.2),s.connect(a),a.connect(n),n.connect(this.sfxGain),s.start(t),s.stop(t+1.2)}playAcidSplash(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.createNoise(.8),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();s.type="lowpass",s.frequency.setValueAtTime(1200,t),s.frequency.exponentialRampToValueAtTime(400,t+.3),i.gain.setValueAtTime(.4,t),i.gain.exponentialRampToValueAtTime(.01,t+.5),e.connect(s),s.connect(i),i.connect(this.sfxGain);const n=this.createNoise(2),a=this.ctx.createGain(),o=this.ctx.createBiquadFilter();o.type="highpass",o.frequency.value=3500,a.gain.setValueAtTime(0,t+.1),a.gain.linearRampToValueAtTime(.2,t+.2),a.gain.exponentialRampToValueAtTime(.01,t+2),n.connect(o),o.connect(a),a.connect(this.sfxGain);const r=this.ctx.createOscillator(),c=this.ctx.createGain();r.type="sine",r.frequency.setValueAtTime(80,t),r.frequency.exponentialRampToValueAtTime(40,t+.2),c.gain.setValueAtTime(.35,t),c.gain.exponentialRampToValueAtTime(.01,t+.3),r.connect(c),c.connect(this.sfxGain),r.start(t),r.stop(t+.3)}playAcidRainMark(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();e.type="sawtooth",e.frequency.setValueAtTime(200,t),e.frequency.exponentialRampToValueAtTime(600,t+1),s.type="bandpass",s.frequency.setValueAtTime(400,t),s.Q.value=5,i.gain.setValueAtTime(.1,t),i.gain.linearRampToValueAtTime(.25,t+.8),i.gain.exponentialRampToValueAtTime(.01,t+1.2),e.connect(s),s.connect(i),i.connect(this.sfxGain),e.start(t),e.stop(t+1.2);for(let n=0;n<3;n++){const a=this.ctx.createOscillator(),o=this.ctx.createGain();a.type="square",a.frequency.value=800,o.gain.setValueAtTime(0,t+n*.3),o.gain.linearRampToValueAtTime(.1,t+n*.3+.05),o.gain.exponentialRampToValueAtTime(.01,t+n*.3+.15),a.connect(o),o.connect(this.sfxGain),a.start(t+n*.3),a.stop(t+n*.3+.2)}}playAcidRainStart(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.createNoise(3),i=this.ctx.createGain(),s=this.ctx.createBiquadFilter();s.type="bandpass",s.frequency.value=2e3,s.Q.value=1,i.gain.setValueAtTime(0,t),i.gain.linearRampToValueAtTime(.3,t+.2),i.gain.setValueAtTime(.25,t+2.5),i.gain.exponentialRampToValueAtTime(.01,t+3),e.connect(s),s.connect(i),i.connect(this.sfxGain);const n=this.createNoise(3),a=this.ctx.createGain(),o=this.ctx.createBiquadFilter();o.type="highpass",o.frequency.value=5e3,a.gain.setValueAtTime(0,t+.1),a.gain.linearRampToValueAtTime(.15,t+.3),a.gain.exponentialRampToValueAtTime(.01,t+3),n.connect(o),o.connect(a),a.connect(this.sfxGain);const r=this.ctx.createOscillator(),c=this.ctx.createGain();r.type="sine",r.frequency.value=50,c.gain.setValueAtTime(.2,t),c.gain.exponentialRampToValueAtTime(.01,t+2),r.connect(c),c.connect(this.sfxGain),r.start(t),r.stop(t+2)}playBossWarning(){if(!this.ctx||!this.sfxGain)return;const t=this.ctx.currentTime,e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sine",e.frequency.setValueAtTime(120,t),e.frequency.exponentialRampToValueAtTime(80,t+2),i.gain.setValueAtTime(.5,t),i.gain.exponentialRampToValueAtTime(.01,t+2.5),e.connect(i),i.connect(this.sfxGain),i.connect(this.reverb),e.start(t),e.stop(t+2.5);const s=this.ctx.createOscillator(),n=this.ctx.createGain();s.type="sine",s.frequency.setValueAtTime(180,t+.5),s.frequency.exponentialRampToValueAtTime(100,t+2.5),n.gain.setValueAtTime(.3,t+.5),n.gain.exponentialRampToValueAtTime(.01,t+3),s.connect(n),n.connect(this.sfxGain),n.connect(this.reverb),s.start(t+.5),s.stop(t+3);const a=this.createNoise(2),o=this.ctx.createGain(),r=this.ctx.createBiquadFilter();r.type="bandpass",r.frequency.value=800,r.Q.value=5,o.gain.setValueAtTime(0,t+1),o.gain.linearRampToValueAtTime(.1,t+1.5),o.gain.exponentialRampToValueAtTime(.01,t+2.5),a.connect(r),r.connect(o),o.connect(this.reverb)}arpInterval=null;currentMusicMode="normal";musicIntervals=[];isLowHpMode=!1;currentEra=1;rainGain=null;rainSource=null;isRainPlaying=!1;thunderInterval=null;setEra(t){let e=1;if(t>10?e=3:t>5&&(e=2),t>=15&&!this.isRainPlaying?this.startRain():t<15&&this.isRainPlaying&&this.stopRain(),e!==this.currentEra&&this.currentMusicMode==="normal"){this.currentEra=e;for(const i of this.musicIntervals)clearInterval(i),clearTimeout(i);this.musicIntervals=[],this.startSynthwaveMusic()}else this.currentEra=e}startRain(){if(!this.ctx||!this.masterGain||this.isRainPlaying)return;this.isRainPlaying=!0,this.rainGain=this.ctx.createGain(),this.rainGain.gain.value=0,this.rainGain.connect(this.masterGain);const t=this.ctx.sampleRate,i=t*4,s=this.ctx.createBuffer(2,i,t);for(let o=0;o<2;o++){const r=s.getChannelData(o);for(let c=0;c<i;c++){let h=(Math.random()*2-1)*.3;Math.random()<.001&&(h+=(Math.random()*2-1)*.8),h+=Math.sin(c/t*2*Math.PI*.5)*.05,r[c]=h}}this.rainSource=this.ctx.createBufferSource(),this.rainSource.buffer=s,this.rainSource.loop=!0;const n=this.ctx.createBiquadFilter();n.type="lowpass",n.frequency.value=3e3,n.Q.value=.5;const a=this.ctx.createBiquadFilter();a.type="highpass",a.frequency.value=200,a.Q.value=.5,this.rainSource.connect(a),a.connect(n),n.connect(this.rainGain),this.rainSource.start(),this.rainGain.gain.linearRampToValueAtTime(.25,this.ctx.currentTime+2),this.startThunder()}startThunder(){if(!this.ctx||!this.masterGain)return;const t=()=>{if(!this.ctx||!this.masterGain||!this.isRainPlaying)return;const e=this.ctx.currentTime,i=this.ctx.createGain();i.gain.value=0,i.connect(this.masterGain);const s=this.ctx.createBuffer(1,this.ctx.sampleRate*3,this.ctx.sampleRate),n=s.getChannelData(0);for(let l=0;l<n.length;l++)n[l]=(Math.random()*2-1)*Math.exp(-l/(this.ctx.sampleRate*.8));const a=this.ctx.createBufferSource();a.buffer=s;const o=this.ctx.createBiquadFilter();o.type="lowpass",o.frequency.value=150+Math.random()*100,o.Q.value=1,a.connect(o),o.connect(i);const r=this.ctx.createOscillator();r.type="sawtooth",r.frequency.value=80+Math.random()*40;const c=this.ctx.createGain();c.gain.value=0;const h=this.ctx.createBiquadFilter();h.type="bandpass",h.frequency.value=2e3,h.Q.value=2,r.connect(h),h.connect(c),c.connect(i),i.gain.setValueAtTime(0,e),i.gain.linearRampToValueAtTime(.6,e+.1),i.gain.exponentialRampToValueAtTime(.01,e+2.5),c.gain.setValueAtTime(0,e),c.gain.linearRampToValueAtTime(.4,e+.02),c.gain.exponentialRampToValueAtTime(.01,e+.2),a.start(e),r.start(e),a.stop(e+3),r.stop(e+.3)};setTimeout(t,2e3+Math.random()*2e3),this.thunderInterval=setInterval(()=>{this.isRainPlaying&&t()},3e3+Math.random()*3e3)}stopRain(){!this.ctx||!this.isRainPlaying||(this.isRainPlaying=!1,this.thunderInterval&&(clearInterval(this.thunderInterval),this.thunderInterval=null),this.rainGain&&this.rainGain.gain.linearRampToValueAtTime(0,this.ctx.currentTime+1),setTimeout(()=>{if(this.rainSource){try{this.rainSource.stop()}catch{}this.rainSource=null}this.rainGain=null},1100))}startSynthwaveMusic(){if(!(!this.ctx||!this.musicGain))switch(this.currentEra){case 1:this.playEra1Music();break;case 2:this.playEra2Music();break;case 3:this.playEra3Music();break}}playEra1Music(){if(!this.ctx||!this.musicGain)return;const t=[55,55,73.4,55,82.4,55,73.4,65.4];let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==1)return;const r=this.ctx.currentTime,c=this.ctx.createOscillator(),h=this.ctx.createBiquadFilter(),l=this.ctx.createGain();c.type="sawtooth",c.frequency.value=t[e],h.type="lowpass",h.frequency.setValueAtTime(300,r),h.frequency.exponentialRampToValueAtTime(800,r+.05),h.frequency.exponentialRampToValueAtTime(200,r+.2),h.Q.value=10,l.gain.setValueAtTime(.15,r),l.gain.exponentialRampToValueAtTime(.01,r+.25),c.connect(h),h.connect(l),l.connect(this.musicGain),c.start(r),c.stop(r+.3),e=(e+1)%t.length};this.musicIntervals.push(setInterval(i,250));const s=[220,277,330,440,330,277];let n=0;const a=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==1)return;const r=this.ctx.currentTime,c=this.ctx.createOscillator(),h=this.ctx.createGain();c.type="square",c.frequency.value=s[n],h.gain.setValueAtTime(.06,r),h.gain.exponentialRampToValueAtTime(.01,r+.1),c.connect(h),h.connect(this.musicGain),c.start(r),c.stop(r+.12),n=(n+1)%s.length};this.musicIntervals.push(setInterval(a,125));const o=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==1)return;const r=this.ctx.currentTime,c=this.ctx.createOscillator(),h=this.ctx.createGain();c.type="sine",c.frequency.setValueAtTime(150,r),c.frequency.exponentialRampToValueAtTime(40,r+.1),h.gain.setValueAtTime(.25,r),h.gain.exponentialRampToValueAtTime(.01,r+.15),c.connect(h),h.connect(this.musicGain),c.start(r),c.stop(r+.15)};this.musicIntervals.push(setInterval(o,500))}playEra2Music(){if(!this.ctx||!this.musicGain)return;const t=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==2)return;const a=this.ctx.currentTime,o=this.ctx.createOscillator(),r=this.ctx.createOscillator(),c=this.ctx.createOscillator(),h=this.ctx.createGain(),l=this.ctx.createGain(),u=this.ctx.createBiquadFilter();o.type="sawtooth",o.frequency.value=41,r.type="triangle",r.frequency.value=41.2,c.type="sine",c.frequency.value=.1,h.gain.value=20,c.connect(h),h.connect(o.frequency),u.type="lowpass",u.frequency.value=150,l.gain.setValueAtTime(.12,a),l.gain.linearRampToValueAtTime(.08,a+3),l.gain.exponentialRampToValueAtTime(.01,a+4),o.connect(u),r.connect(u),u.connect(l),l.connect(this.musicGain),c.start(a),o.start(a),r.start(a),c.stop(a+4),o.stop(a+4),r.stop(a+4)};t(),this.musicIntervals.push(setInterval(t,4e3));let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==2)return;const a=this.ctx.currentTime;if(e%2===0){const o=this.ctx.createOscillator(),r=this.ctx.createGain();o.type="sine",o.frequency.setValueAtTime(80,a),o.frequency.exponentialRampToValueAtTime(20,a+.3),r.gain.setValueAtTime(.3,a),r.gain.exponentialRampToValueAtTime(.01,a+.4),o.connect(r),r.connect(this.musicGain),o.start(a),o.stop(a+.4)}e++};this.musicIntervals.push(setInterval(i,600));const s=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==2)return;const a=this.ctx.currentTime,o=600+Math.random()*400,r=this.ctx.createOscillator(),c=this.ctx.createGain();r.type="sine",r.frequency.setValueAtTime(o,a),r.frequency.linearRampToValueAtTime(o*.7,a+2),c.gain.setValueAtTime(0,a),c.gain.linearRampToValueAtTime(.04,a+.5),c.gain.linearRampToValueAtTime(0,a+2),r.connect(c),c.connect(this.musicGain),r.start(a),r.stop(a+2)};this.musicIntervals.push(setInterval(s,3e3+Math.random()*2e3));const n=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==2)return;const a=this.ctx.currentTime,o=this.ctx.sampleRate*.5,r=this.ctx.createBuffer(1,o,this.ctx.sampleRate),c=r.getChannelData(0);for(let p=0;p<o;p++)c[p]=(Math.random()*2-1)*Math.exp(-p/(o*.5));const h=this.ctx.createBufferSource();h.buffer=r;const l=this.ctx.createBiquadFilter();l.type="lowpass",l.frequency.value=200;const u=this.ctx.createGain();u.gain.setValueAtTime(.08,a),u.gain.exponentialRampToValueAtTime(.01,a+.5),h.connect(l),l.connect(u),u.connect(this.musicGain),h.start(a),h.stop(a+.5)};this.musicIntervals.push(setInterval(n,1500))}playEra3Music(){if(!this.ctx||!this.musicGain)return;const t=[110,110,146.8,110,130.8,110,164.8,146.8];let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==3)return;const h=this.ctx.currentTime,l=this.ctx.createOscillator(),u=this.ctx.createBiquadFilter(),p=this.ctx.createGain();l.type="sawtooth",l.frequency.value=t[e],u.type="lowpass",u.frequency.setValueAtTime(400,h),u.frequency.exponentialRampToValueAtTime(150,h+.15),p.gain.setValueAtTime(.12,h),p.gain.exponentialRampToValueAtTime(.01,h+.2),l.connect(u),u.connect(p),p.connect(this.musicGain),l.start(h),l.stop(h+.22),e=(e+1)%t.length};this.musicIntervals.push(setInterval(i,200));const s=[880,1046,1318,1760,1318,1046,880,659];let n=0;const a=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==3)return;const h=this.ctx.currentTime,l=this.ctx.createOscillator(),u=this.ctx.createGain(),p=this.ctx.createDelay(),m=this.ctx.createGain();l.type="triangle",l.frequency.value=s[n],p.delayTime.value=.15,m.gain.value=.3,u.gain.setValueAtTime(.05,h),u.gain.exponentialRampToValueAtTime(.01,h+.1),l.connect(u),l.connect(p),p.connect(m),m.connect(this.musicGain),u.connect(this.musicGain),l.start(h),l.stop(h+.12),n=(n+1)%s.length};this.musicIntervals.push(setInterval(a,100));const o=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==3)return;const h=this.ctx.currentTime,l=this.ctx.createOscillator(),u=this.ctx.createGain();l.type="sine",l.frequency.setValueAtTime(200,h),l.frequency.exponentialRampToValueAtTime(50,h+.08),u.gain.setValueAtTime(.2,h),u.gain.exponentialRampToValueAtTime(.01,h+.12),l.connect(u),u.connect(this.musicGain),l.start(h),l.stop(h+.12)};this.musicIntervals.push(setInterval(o,400));const r=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==3)return;const h=this.ctx.currentTime,l=[220,277,330,440];for(const u of l){const p=this.ctx.createOscillator(),m=this.ctx.createGain();p.type="sine",p.frequency.value=u,m.gain.setValueAtTime(0,h),m.gain.linearRampToValueAtTime(.03,h+.5),m.gain.linearRampToValueAtTime(.02,h+2),m.gain.linearRampToValueAtTime(0,h+3),p.connect(m),m.connect(this.musicGain),p.start(h),p.stop(h+3.5)}};r(),this.musicIntervals.push(setInterval(r,4e3));const c=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal"||this.currentEra!==3)return;const h=this.ctx.currentTime,l=this.ctx.createOscillator(),u=this.ctx.createGain();l.type="sawtooth",l.frequency.setValueAtTime(1500+Math.random()*1e3,h),l.frequency.exponentialRampToValueAtTime(100,h+.1),u.gain.setValueAtTime(.06,h),u.gain.exponentialRampToValueAtTime(.001,h+.1),l.connect(u),u.connect(this.musicGain),l.start(h),l.stop(h+.1)};this.musicIntervals.push(setInterval(c,800+Math.random()*600))}setLowHpMode(t){if(!(!this.ctx||!this.musicGain)&&!(this.currentMusicMode!=="normal"&&this.currentMusicMode!=="low_hp")){if(t&&!this.isLowHpMode){this.isLowHpMode=!0,this.currentMusicMode="low_hp";for(const e of this.musicIntervals)clearInterval(e),clearTimeout(e);this.musicIntervals=[],this.playLowHpMusic()}else if(!t&&this.isLowHpMode){this.isLowHpMode=!1,this.currentMusicMode="normal";for(const e of this.musicIntervals)clearInterval(e),clearTimeout(e);this.musicIntervals=[],this.startSynthwaveMusic()}}}playLowHpMusic(){if(!this.ctx||!this.musicGain)return;const t=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="low_hp")return;const a=this.ctx.currentTime;for(let o=0;o<2;o++){const r=this.ctx.createOscillator(),c=this.ctx.createGain();r.type="sine",r.frequency.value=40;const h=o*.15;c.gain.setValueAtTime(0,a+h),c.gain.linearRampToValueAtTime(.3,a+h+.05),c.gain.exponentialRampToValueAtTime(.01,a+h+.2),r.connect(c),c.connect(this.musicGain),r.start(a+h),r.stop(a+h+.25)}};this.musicIntervals.push(setInterval(t,800));const e=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="low_hp")return;const a=this.ctx.currentTime,o=this.ctx.createOscillator(),r=this.ctx.createOscillator(),c=this.ctx.createGain(),h=this.ctx.createBiquadFilter();o.type="sawtooth",o.frequency.value=55,r.type="sawtooth",r.frequency.value=55.5,h.type="lowpass",h.frequency.value=200,h.Q.value=5,c.gain.setValueAtTime(.1,a),c.gain.linearRampToValueAtTime(.15,a+1),c.gain.linearRampToValueAtTime(.05,a+2),o.connect(h),r.connect(h),h.connect(c),c.connect(this.musicGain),o.start(a),o.stop(a+2.5),r.start(a),r.stop(a+2.5)};e(),this.musicIntervals.push(setInterval(e,2500));const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="low_hp")return;const a=this.ctx.currentTime,o=1+Math.floor(Math.random()*3);for(let r=0;r<o;r++){const c=Math.floor(this.ctx.sampleRate*(.02+Math.random()*.03)),h=this.ctx.createBuffer(1,c,this.ctx.sampleRate),l=h.getChannelData(0);for(let f=0;f<c;f++)l[f]=(Math.random()*2-1)*Math.exp(-f/(c*.3));const u=this.ctx.createBufferSource();u.buffer=h;const p=this.ctx.createBiquadFilter();p.type="highpass",p.frequency.value=3e3+Math.random()*5e3;const m=this.ctx.createGain();m.gain.setValueAtTime(.05+Math.random()*.05,a+r*.05),m.gain.exponentialRampToValueAtTime(.001,a+r*.05+.05),u.connect(p),p.connect(m),m.connect(this.musicGain),u.start(a+r*.05),u.stop(a+r*.05+.05)}};this.musicIntervals.push(setInterval(i,500+Math.random()*500));const s=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="low_hp")return;const a=this.ctx.currentTime,o=this.ctx.createOscillator(),r=this.ctx.createGain();o.type="square";const c=[220,233.1],h=c[Math.floor(Math.random()*c.length)];o.frequency.value=h,r.gain.setValueAtTime(0,a),r.gain.linearRampToValueAtTime(.08,a+.1),r.gain.linearRampToValueAtTime(.06,a+.3),r.gain.exponentialRampToValueAtTime(.01,a+.5),o.connect(r),r.connect(this.musicGain),o.start(a),o.stop(a+.5)};this.musicIntervals.push(setInterval(s,1500+Math.random()*1e3));const n=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="low_hp")return;const a=this.ctx.currentTime,o=this.ctx.sampleRate*.1,r=this.ctx.createBuffer(1,o,this.ctx.sampleRate),c=r.getChannelData(0);for(let p=0;p<o;p++)c[p]=Math.random()>.7?(Math.random()*2-1)*.5:0;const h=this.ctx.createBufferSource();h.buffer=r;const l=this.ctx.createBiquadFilter();l.type="bandpass",l.frequency.value=2e3,l.Q.value=3;const u=this.ctx.createGain();u.gain.setValueAtTime(.03,a),u.gain.exponentialRampToValueAtTime(.001,a+.1),h.connect(l),l.connect(u),u.connect(this.musicGain),h.start(a),h.stop(a+.1)};this.musicIntervals.push(setInterval(n,300+Math.random()*400))}bossGreenPhase=1;setBossMusic(t){if(!(!this.ctx||!this.musicGain)){for(const e of this.musicIntervals)clearInterval(e),clearTimeout(e);if(this.musicIntervals=[],this.bossGreenPhase=1,t===null)this.currentMusicMode="normal",this.startSynthwaveMusic();else switch(this.currentMusicMode=t,t){case"boss_green":this.playBossGreenMusic();break;case"boss_black":this.playBossBlackMusic();break;case"boss_blue":this.playBossBlueMusic();break}}}setBossGreenPhase2(){if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green"||this.bossGreenPhase===2)return;this.bossGreenPhase=2;const t=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const s=this.ctx.currentTime,n=this.ctx.createOscillator(),a=this.ctx.createOscillator(),o=this.ctx.createGain(),r=this.ctx.createWaveShaper();n.type="sine",n.frequency.setValueAtTime(200,s),n.frequency.exponentialRampToValueAtTime(30,s+.15),a.type="sine",a.frequency.setValueAtTime(100,s),a.frequency.exponentialRampToValueAtTime(20,s+.2);const c=new Float32Array(256);for(let h=0;h<256;h++){const l=h/128-1;c[h]=Math.tanh(l*5)}r.curve=c,o.gain.setValueAtTime(.8,s),o.gain.exponentialRampToValueAtTime(.01,s+.25),n.connect(r),a.connect(r),r.connect(o),o.connect(this.musicGain),n.start(s),n.stop(s+.25),a.start(s),a.stop(s+.25)};this.musicIntervals.push(setInterval(t,187));const e=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const s=this.ctx.currentTime,n=this.ctx.createOscillator(),a=this.ctx.createOscillator(),o=this.ctx.createBiquadFilter(),r=this.ctx.createGain();n.type="sawtooth",a.type="square";const c=[110,110,146.8,110],h=c[Math.floor(Math.random()*c.length)];n.frequency.value=h,a.frequency.value=h*1.5,o.type="lowpass",o.Q.value=25,o.frequency.setValueAtTime(300,s),o.frequency.exponentialRampToValueAtTime(2e3,s+.05),o.frequency.exponentialRampToValueAtTime(150,s+.15),r.gain.setValueAtTime(.4,s),r.gain.exponentialRampToValueAtTime(.01,s+.15),n.connect(o),a.connect(o),o.connect(r),r.connect(this.musicGain),n.start(s),a.start(s),n.stop(s+.2),a.stop(s+.2)};this.musicIntervals.push(setInterval(e,93));const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const s=this.ctx.currentTime,n=this.ctx.createOscillator(),a=this.ctx.createGain();n.type="square",n.frequency.setValueAtTime(500,s),n.frequency.linearRampToValueAtTime(900,s+.15),n.frequency.linearRampToValueAtTime(500,s+.3),a.gain.setValueAtTime(.12,s),a.gain.linearRampToValueAtTime(.18,s+.15),a.gain.linearRampToValueAtTime(0,s+.3),n.connect(a),a.connect(this.musicGain),n.start(s),n.stop(s+.35)};this.musicIntervals.push(setInterval(i,1500))}vortexGain=null;vortexOsc=null;vortexNoise=null;isStormMode=!1;stormGain=null;playVortexSound(t){if(!(!this.ctx||!this.masterGain))if(t){this.vortexGain=this.ctx.createGain(),this.vortexGain.gain.value=0,this.vortexGain.connect(this.masterGain),this.vortexOsc=this.ctx.createOscillator(),this.vortexOsc.type="sawtooth",this.vortexOsc.frequency.value=60;const e=this.ctx.createGain();e.gain.value=.15;const i=this.ctx.createOscillator();i.type="sine",i.frequency.value=3;const s=this.ctx.createGain();s.gain.value=30,i.connect(s),s.connect(this.vortexOsc.frequency);const n=this.ctx.createBiquadFilter();n.type="lowpass",n.frequency.value=200,n.Q.value=5,this.vortexOsc.connect(n),n.connect(e),e.connect(this.vortexGain);const a=this.ctx.createBuffer(1,this.ctx.sampleRate*4,this.ctx.sampleRate),o=a.getChannelData(0);for(let h=0;h<o.length;h++)o[h]=(Math.random()*2-1)*.5;this.vortexNoise=this.ctx.createBufferSource(),this.vortexNoise.buffer=a,this.vortexNoise.loop=!0;const r=this.ctx.createBiquadFilter();r.type="bandpass",r.frequency.value=400,r.Q.value=2;const c=this.ctx.createGain();c.gain.value=.3,this.vortexNoise.connect(r),r.connect(c),c.connect(this.vortexGain),this.vortexOsc.start(),i.start(),this.vortexNoise.start(),this.vortexGain.gain.linearRampToValueAtTime(.5,this.ctx.currentTime+.5),this.activateStormMode()}else this.vortexGain&&this.vortexGain.gain.linearRampToValueAtTime(0,this.ctx.currentTime+.5),this.deactivateStormMode(),setTimeout(()=>{if(this.vortexOsc){try{this.vortexOsc.stop()}catch{}this.vortexOsc=null}if(this.vortexNoise){try{this.vortexNoise.stop()}catch{}this.vortexNoise=null}this.vortexGain=null},600)}activateStormMode(){if(!this.ctx||!this.musicGain||this.isStormMode)return;this.isStormMode=!0,this.stormGain=this.ctx.createGain(),this.stormGain.gain.value=0,this.stormGain.connect(this.musicGain),this.stormGain.gain.linearRampToValueAtTime(1,this.ctx.currentTime+.5);const t=()=>{if(!this.ctx||!this.stormGain||!this.isStormMode)return;const n=this.ctx.currentTime,a=this.ctx.createOscillator(),o=this.ctx.createBiquadFilter(),r=this.ctx.createGain();a.type="sawtooth",a.frequency.setValueAtTime(100,n),a.frequency.exponentialRampToValueAtTime(800,n+2),o.type="lowpass",o.frequency.setValueAtTime(200,n),o.frequency.exponentialRampToValueAtTime(4e3,n+2),o.Q.value=8,r.gain.setValueAtTime(0,n),r.gain.linearRampToValueAtTime(.15,n+1),r.gain.linearRampToValueAtTime(0,n+2),a.connect(o),o.connect(r),r.connect(this.stormGain),a.start(n),a.stop(n+2.1)};this.musicIntervals.push(setInterval(t,2e3)),t();const e=()=>{if(!this.ctx||!this.stormGain||!this.isStormMode)return;const n=this.ctx.currentTime,a=this.ctx.createOscillator(),o=this.ctx.createGain();a.type="sine",a.frequency.setValueAtTime(80,n),a.frequency.exponentialRampToValueAtTime(25,n+.5),o.gain.setValueAtTime(.4,n),o.gain.exponentialRampToValueAtTime(.01,n+.6),a.connect(o),o.connect(this.stormGain),a.start(n),a.stop(n+.7)};this.musicIntervals.push(setInterval(e,500));const i=()=>{if(!this.ctx||!this.stormGain||!this.isStormMode)return;const n=this.ctx.currentTime,a=this.ctx.sampleRate*1,o=this.ctx.createBuffer(1,a,this.ctx.sampleRate),r=o.getChannelData(0);for(let u=0;u<a;u++)r[u]=Math.random()*2-1;const c=this.ctx.createBufferSource();c.buffer=o;const h=this.ctx.createBiquadFilter();h.type="bandpass",h.frequency.setValueAtTime(500,n),h.frequency.exponentialRampToValueAtTime(8e3,n+.5),h.frequency.exponentialRampToValueAtTime(500,n+1),h.Q.value=5;const l=this.ctx.createGain();l.gain.setValueAtTime(0,n),l.gain.linearRampToValueAtTime(.1,n+.25),l.gain.linearRampToValueAtTime(.1,n+.75),l.gain.linearRampToValueAtTime(0,n+1),c.connect(h),h.connect(l),l.connect(this.stormGain),c.start(n),c.stop(n+1.1)};this.musicIntervals.push(setInterval(i,1e3)),i();const s=()=>{if(!this.ctx||!this.stormGain||!this.isStormMode)return;const n=this.ctx.currentTime,a=this.ctx.sampleRate*.02,o=this.ctx.createBuffer(1,a,this.ctx.sampleRate),r=o.getChannelData(0);for(let u=0;u<a;u++)r[u]=Math.random()*2-1;const c=this.ctx.createBufferSource();c.buffer=o;const h=this.ctx.createBiquadFilter();h.type="highpass",h.frequency.value=1e4;const l=this.ctx.createGain();l.gain.setValueAtTime(.12,n),l.gain.exponentialRampToValueAtTime(.001,n+.02),c.connect(h),h.connect(l),l.connect(this.stormGain),c.start(n),c.stop(n+.03)};this.musicIntervals.push(setInterval(s,119))}deactivateStormMode(){this.isStormMode&&(this.isStormMode=!1,this.stormGain&&this.ctx&&this.stormGain.gain.linearRampToValueAtTime(0,this.ctx.currentTime+1),setTimeout(()=>{this.stormGain=null},1100))}playBossGreenMusic(){if(!this.ctx||!this.musicGain)return;const t=[55,55,110,55,82.4,110,73.4,55],e=[0,0,1,0,1,1,0,1];let i=0;const s=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createOscillator(),u=this.ctx.createBiquadFilter(),p=this.ctx.createGain();h.type="sawtooth",l.type="square";const m=t[i];h.frequency.value=m,l.frequency.value=m*1.01,u.type="lowpass",u.Q.value=22;const f=e[i]===1,d=150+Math.random()*100,y=1200+Math.random()*800;u.frequency.setValueAtTime(d,c),u.frequency.exponentialRampToValueAtTime(y,c+.03),u.frequency.exponentialRampToValueAtTime(f?y*.7:200,c+.1);const v=i%4===0?.5:.3;p.gain.setValueAtTime(v,c),p.gain.exponentialRampToValueAtTime(.01,c+.12),h.connect(u),l.connect(u),u.connect(p),p.connect(this.musicGain),h.start(c),l.start(c),h.stop(c+.15),l.stop(c+.15),i=(i+1)%t.length};this.musicIntervals.push(setInterval(s,100));const n=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createOscillator(),u=this.ctx.createGain(),p=this.ctx.createGain();h.type="sine",h.frequency.setValueAtTime(180,c),h.frequency.exponentialRampToValueAtTime(35,c+.08),l.type="triangle",l.frequency.value=1500,u.gain.setValueAtTime(.7,c),u.gain.exponentialRampToValueAtTime(.01,c+.25),p.gain.setValueAtTime(.2,c),p.gain.exponentialRampToValueAtTime(.001,c+.02),h.connect(u),l.connect(p),u.connect(this.musicGain),p.connect(this.musicGain),h.start(c),l.start(c),h.stop(c+.3),l.stop(c+.03)};this.musicIntervals.push(setInterval(n,400));let a=0;const o=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const c=this.ctx.currentTime,h=this.createNoise(.04),l=this.ctx.createBiquadFilter(),u=this.ctx.createGain();l.type="highpass",l.frequency.value=9e3;const p=a%2===1;u.gain.setValueAtTime(p?.18:.1,c),u.gain.exponentialRampToValueAtTime(.001,c+.04),h.connect(l),l.connect(u),u.connect(this.musicGain),a++};this.musicIntervals.push(setInterval(o,207));const r=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_green")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createBiquadFilter(),u=this.ctx.createGain();h.type="sawtooth",h.frequency.setValueAtTime(200+Math.random()*100,c),h.frequency.exponentialRampToValueAtTime(800+Math.random()*400,c+.3),l.type="bandpass",l.frequency.setValueAtTime(500,c),l.frequency.exponentialRampToValueAtTime(3e3,c+.3),l.Q.value=10,u.gain.setValueAtTime(.1,c),u.gain.linearRampToValueAtTime(.15,c+.15),u.gain.exponentialRampToValueAtTime(.01,c+.4),h.connect(l),l.connect(u),u.connect(this.musicGain),h.start(c),h.stop(c+.4)};this.musicIntervals.push(setInterval(r,1656))}playBossBlackMusic(){if(!this.ctx||!this.musicGain)return;const t=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_black")return;const l=this.ctx.currentTime,u=this.ctx.createOscillator(),p=this.ctx.createOscillator(),m=this.ctx.createWaveShaper(),f=this.ctx.createGain();u.type="sine",u.frequency.setValueAtTime(200,l),u.frequency.exponentialRampToValueAtTime(50,l+.04),u.frequency.exponentialRampToValueAtTime(30,l+.15),p.type="sine",p.frequency.setValueAtTime(60,l),p.frequency.exponentialRampToValueAtTime(25,l+.25);const d=new Float32Array(256);for(let y=0;y<256;y++){const v=y/128-1;d[y]=Math.tanh(v*8)}m.curve=d,f.gain.setValueAtTime(.9,l),f.gain.exponentialRampToValueAtTime(.01,l+.3),u.connect(m),p.connect(f),m.connect(f),f.connect(this.musicGain),u.start(l),u.stop(l+.3),p.start(l),p.stop(l+.35)};this.musicIntervals.push(setInterval(t,461));const e=[36.7,36.7,32.7,36.7,41.2,36.7,32.7,29.1];let i=0;const s=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_black")return;const l=this.ctx.currentTime,u=e[i],p=this.ctx.createOscillator(),m=this.ctx.createBiquadFilter(),f=this.ctx.createGain();p.type="sawtooth",p.frequency.value=u,m.type="lowpass",m.frequency.setValueAtTime(400,l),m.frequency.exponentialRampToValueAtTime(80,l+.3),m.Q.value=10,f.gain.setValueAtTime(.35,l),f.gain.exponentialRampToValueAtTime(.01,l+.4),p.connect(m),m.connect(f),f.connect(this.musicGain),p.start(l),p.stop(l+.45);for(let d=1;d<=3;d++){const y=this.ctx.createOscillator(),v=this.ctx.createBiquadFilter(),b=this.ctx.createGain(),g=l+d*.15,w=.15/d;y.type="sine",y.frequency.value=u,v.type="lowpass",v.frequency.value=200-d*40,b.gain.setValueAtTime(w,g),b.gain.exponentialRampToValueAtTime(.001,g+.25),y.connect(v),v.connect(b),b.connect(this.musicGain),y.start(g),y.stop(g+.3)}i=(i+1)%e.length};this.musicIntervals.push(setInterval(s,461));const n=[{type:"kick",vol:1},{type:"none",vol:0},{type:"hat",vol:.6},{type:"none",vol:0},{type:"snare",vol:1},{type:"none",vol:0},{type:"hat",vol:.5},{type:"kick",vol:.8},{type:"none",vol:0},{type:"none",vol:0},{type:"hat",vol:.7},{type:"none",vol:0},{type:"snare",vol:1},{type:"none",vol:0},{type:"hat",vol:.5},{type:"kick",vol:.7}];let a=0;const o=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_black")return;const l=this.ctx.currentTime,u=n[a];if(u.type==="kick"){const p=this.ctx.createOscillator(),m=this.ctx.createGain();p.type="sine",p.frequency.setValueAtTime(180,l),p.frequency.exponentialRampToValueAtTime(60,l+.03),p.frequency.exponentialRampToValueAtTime(40,l+.08),m.gain.setValueAtTime(.5*u.vol,l),m.gain.exponentialRampToValueAtTime(.01,l+.12),p.connect(m),m.connect(this.musicGain),p.start(l),p.stop(l+.15)}else if(u.type==="snare"){const p=this.ctx.createOscillator(),m=this.ctx.createGain();p.type="triangle",p.frequency.setValueAtTime(250,l),p.frequency.exponentialRampToValueAtTime(150,l+.02),m.gain.setValueAtTime(.2*u.vol,l),m.gain.exponentialRampToValueAtTime(.01,l+.08),p.connect(m),m.connect(this.musicGain),p.start(l),p.stop(l+.1);const f=this.ctx.sampleRate*.1,d=this.ctx.createBuffer(1,f,this.ctx.sampleRate),y=d.getChannelData(0);for(let w=0;w<f;w++)y[w]=(Math.random()*2-1)*Math.exp(-w/(this.ctx.sampleRate*.025));const v=this.ctx.createBufferSource();v.buffer=d;const b=this.ctx.createBiquadFilter();b.type="bandpass",b.frequency.value=3e3,b.Q.value=1;const g=this.ctx.createGain();g.gain.setValueAtTime(.35*u.vol,l),g.gain.exponentialRampToValueAtTime(.01,l+.1),v.connect(b),b.connect(g),g.connect(this.musicGain),v.start(l),v.stop(l+.12)}else if(u.type==="hat"){const p=this.ctx.sampleRate*.04,m=this.ctx.createBuffer(1,p,this.ctx.sampleRate),f=m.getChannelData(0);for(let b=0;b<p;b++)f[b]=Math.random()*2-1;const d=this.ctx.createBufferSource();d.buffer=m;const y=this.ctx.createBiquadFilter();y.type="highpass",y.frequency.value=7e3;const v=this.ctx.createGain();v.gain.setValueAtTime(.15*u.vol,l),v.gain.exponentialRampToValueAtTime(.001,l+.035),d.connect(y),y.connect(v),v.connect(this.musicGain),d.start(l),d.stop(l+.045)}a=(a+1)%n.length};this.musicIntervals.push(setInterval(o,115));const r=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_black")return;const l=this.ctx.currentTime,u=[146.8,174.6,220];for(const p of u){const m=this.ctx.createOscillator(),f=this.ctx.createBiquadFilter(),d=this.ctx.createGain();m.type="sawtooth",m.frequency.value=p,f.type="lowpass",f.frequency.setValueAtTime(2e3,l),f.frequency.exponentialRampToValueAtTime(300,l+.2),f.Q.value=5,d.gain.setValueAtTime(.08,l),d.gain.exponentialRampToValueAtTime(.001,l+.25),m.connect(f),f.connect(d),d.connect(this.musicGain),m.start(l),m.stop(l+.3);for(let y=1;y<=5;y++){const v=this.ctx.createOscillator(),b=this.ctx.createBiquadFilter(),g=this.ctx.createGain(),w=l+y*.18;v.type="sine",v.frequency.value=p,b.type="lowpass",b.frequency.value=800-y*120,g.gain.setValueAtTime(.04/y,w),g.gain.exponentialRampToValueAtTime(.001,w+.2),v.connect(b),b.connect(g),g.connect(this.musicGain),v.start(w),v.stop(w+.25)}}};this.musicIntervals.push(setInterval(r,1844));const c=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_black")return;const l=this.ctx.currentTime,u=this.ctx.createOscillator(),p=this.ctx.createOscillator(),m=this.ctx.createGain(),f=this.ctx.createGain();u.type="sine",u.frequency.value=36.7,p.type="sine",p.frequency.value=.2,m.gain.value=3,p.connect(m),m.connect(u.frequency),f.gain.setValueAtTime(0,l),f.gain.linearRampToValueAtTime(.25,l+1),f.gain.linearRampToValueAtTime(.2,l+3),f.gain.linearRampToValueAtTime(0,l+4),u.connect(f),f.connect(this.musicGain),p.start(l),u.start(l),p.stop(l+4.5),u.stop(l+4.5)};c(),this.musicIntervals.push(setInterval(c,3688));const h=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_black"||Math.random()>.5)return;const l=this.ctx.currentTime,u=this.ctx.createOscillator(),p=this.ctx.createBiquadFilter(),m=this.ctx.createGain();u.type="sawtooth",Math.random()>.5?(u.frequency.setValueAtTime(100,l),u.frequency.exponentialRampToValueAtTime(800,l+1)):(u.frequency.setValueAtTime(600,l),u.frequency.exponentialRampToValueAtTime(50,l+1.5)),p.type="lowpass",p.frequency.setValueAtTime(3e3,l),p.frequency.exponentialRampToValueAtTime(200,l+1.5),p.Q.value=8,m.gain.setValueAtTime(.1,l),m.gain.exponentialRampToValueAtTime(.001,l+1.5),u.connect(p),p.connect(m),m.connect(this.musicGain),u.start(l),u.stop(l+1.6)};this.musicIntervals.push(setInterval(h,3688))}playVortexRiser(){if(!this.ctx||!this.musicGain)return;const t=this.ctx.currentTime,e=2,i=this.ctx.sampleRate*e,s=this.ctx.createBuffer(1,i,this.ctx.sampleRate),n=s.getChannelData(0);for(let p=0;p<i;p++)n[p]=Math.random()*2-1;const a=this.ctx.createBufferSource();a.buffer=s;const o=this.ctx.createBiquadFilter();o.type="bandpass",o.frequency.setValueAtTime(200,t),o.frequency.exponentialRampToValueAtTime(8e3,t+e),o.Q.value=5;const r=this.ctx.createGain();r.gain.setValueAtTime(0,t),r.gain.linearRampToValueAtTime(.3,t+e*.8),r.gain.linearRampToValueAtTime(.5,t+e),a.connect(o),o.connect(r),r.connect(this.musicGain),a.start(t),a.stop(t+e+.1);const c=this.ctx.createOscillator(),h=this.ctx.createBiquadFilter(),l=this.ctx.createGain();c.type="sawtooth",c.frequency.setValueAtTime(50,t),c.frequency.exponentialRampToValueAtTime(400,t+e),h.type="lowpass",h.frequency.setValueAtTime(100,t),h.frequency.exponentialRampToValueAtTime(2e3,t+e),h.Q.value=8,l.gain.setValueAtTime(0,t),l.gain.linearRampToValueAtTime(.25,t+e),c.connect(h),h.connect(l),l.connect(this.musicGain),c.start(t),c.stop(t+e+.1);const u=(p,m)=>{if(!this.ctx||!this.musicGain)return;const f=this.ctx.createOscillator(),d=this.ctx.createGain();f.type="sine",f.frequency.setValueAtTime(100,p),f.frequency.exponentialRampToValueAtTime(30,p+.1),d.gain.setValueAtTime(m,p),d.gain.exponentialRampToValueAtTime(.001,p+.15),f.connect(d),d.connect(this.musicGain),f.start(p),f.stop(p+.2)};u(t+.5,.15),u(t+1,.2),u(t+1.3,.25),u(t+1.5,.3),u(t+1.65,.35),u(t+1.8,.4),u(t+1.9,.45)}playBossBlueMusic(){if(!this.ctx||!this.musicGain)return;const t=[110,110,146.8,164.8,110,130.8,146.8,110];let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_blue")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createGain(),u=this.ctx.createBiquadFilter();h.type="square",h.frequency.value=t[e],u.type="lowpass",u.frequency.setValueAtTime(800,c),u.frequency.exponentialRampToValueAtTime(200,c+.2),l.gain.setValueAtTime(.15,c),l.gain.linearRampToValueAtTime(0,c+.2),h.connect(u),u.connect(l),l.connect(this.musicGain),h.start(c),h.stop(c+.25),e=(e+1)%t.length};this.musicIntervals.push(setInterval(i,250));const s=[880,1046,1318,1567,1318,1046];let n=0;const a=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_blue")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createGain();h.type="triangle",h.frequency.value=s[n],l.gain.setValueAtTime(.08,c),l.gain.exponentialRampToValueAtTime(.001,c+.1),h.connect(l),l.connect(this.musicGain),h.start(c),h.stop(c+.12),n=(n+1)%s.length};this.musicIntervals.push(setInterval(a,125));const o=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_blue")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createGain();h.type="sawtooth",h.frequency.setValueAtTime(2e3,c),h.frequency.exponentialRampToValueAtTime(100,c+.15),l.gain.setValueAtTime(.1,c),l.gain.exponentialRampToValueAtTime(.001,c+.15),h.connect(l),l.connect(this.musicGain),h.start(c),h.stop(c+.15)};this.musicIntervals.push(setInterval(o,500+Math.random()*300));const r=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="boss_blue")return;const c=this.ctx.currentTime,h=this.ctx.createOscillator(),l=this.ctx.createGain();h.type="sine",h.frequency.setValueAtTime(150,c),h.frequency.exponentialRampToValueAtTime(50,c+.1),l.gain.setValueAtTime(.2,c),l.gain.exponentialRampToValueAtTime(.001,c+.15),h.connect(l),l.connect(this.musicGain),h.start(c),h.stop(c+.15)};this.musicIntervals.push(setInterval(r,500))}playBassline(){if(!this.ctx||!this.musicGain)return;const t=[55,55,73.4,82.4];let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal")return;const s=this.ctx.currentTime,n=this.ctx.createOscillator(),a=this.ctx.createOscillator(),o=this.ctx.createGain(),r=this.ctx.createBiquadFilter();n.type="sawtooth",n.frequency.value=t[e],a.type="square",a.frequency.value=t[e]*1.005,r.type="lowpass",r.frequency.setValueAtTime(300,s),r.frequency.linearRampToValueAtTime(150,s+.8),o.gain.setValueAtTime(.2,s),o.gain.linearRampToValueAtTime(.15,s+.1),o.gain.linearRampToValueAtTime(0,s+.9),n.connect(r),a.connect(r),r.connect(o),o.connect(this.musicGain),n.start(s),n.stop(s+1),a.start(s),a.stop(s+1),e=(e+1)%t.length,setTimeout(i,1e3)};i()}playArpeggio(){if(!this.ctx||!this.musicGain)return;const t=[440,523,587,659,784,659,587,523];let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal")return;const s=this.ctx.currentTime,n=this.ctx.createOscillator(),a=this.ctx.createGain(),o=this.ctx.createBiquadFilter(),r=this.ctx.createDelay(),c=this.ctx.createGain();n.type="square",n.frequency.value=t[e],o.type="lowpass",o.frequency.setValueAtTime(2e3,s),o.frequency.exponentialRampToValueAtTime(500,s+.15),o.Q.value=5,a.gain.setValueAtTime(.08,s),a.gain.exponentialRampToValueAtTime(.01,s+.12),r.delayTime.value=.25,c.gain.value=.3,n.connect(o),o.connect(a),a.connect(this.musicGain),a.connect(r),r.connect(c),c.connect(this.musicGain),c.connect(this.reverb),n.start(s),n.stop(s+.15),e=(e+1)%t.length,setTimeout(i,125)};setTimeout(i,2e3)}playPad(){if(!this.ctx||!this.musicGain)return;const t=[[220,261.6,329.6],[196,246.9,293.7],[174.6,220,261.6],[164.8,196,246.9]];let e=0;const i=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal")return;const s=this.ctx.currentTime;t[e].forEach((a,o)=>{const r=this.ctx.createOscillator(),c=this.ctx.createOscillator(),h=this.ctx.createGain(),l=this.ctx.createBiquadFilter();r.type="sawtooth",r.frequency.value=a,c.type="triangle",c.frequency.value=a*1.002,l.type="lowpass",l.frequency.value=800,l.Q.value=1,h.gain.setValueAtTime(0,s),h.gain.linearRampToValueAtTime(.03,s+1),h.gain.linearRampToValueAtTime(.03,s+3),h.gain.linearRampToValueAtTime(0,s+4),r.connect(l),c.connect(l),l.connect(h),h.connect(this.musicGain),h.connect(this.reverb),r.start(s+o*.1),r.stop(s+4.5),c.start(s+o*.1),c.stop(s+4.5)}),e=(e+1)%t.length,setTimeout(i,4e3)};setTimeout(i,500)}playDrums(){if(!this.ctx||!this.musicGain)return;let t=0;const e=()=>{if(!this.ctx||!this.musicGain||this.currentMusicMode!=="normal")return;const i=this.ctx.currentTime;if(t%4===0||t%4===2){const o=this.ctx.createOscillator(),r=this.ctx.createGain();o.type="sine",o.frequency.setValueAtTime(150,i),o.frequency.exponentialRampToValueAtTime(40,i+.1),r.gain.setValueAtTime(.3,i),r.gain.exponentialRampToValueAtTime(.01,i+.15),o.connect(r),r.connect(this.musicGain),o.start(i),o.stop(i+.2)}if(t%4===1||t%4===3){const o=this.createNoise(.15),r=this.ctx.createGain(),c=this.ctx.createBiquadFilter();c.type="highpass",c.frequency.value=1e3,r.gain.setValueAtTime(.15,i),r.gain.exponentialRampToValueAtTime(.01,i+.1),o.connect(c),c.connect(r),r.connect(this.musicGain);const h=this.ctx.createOscillator(),l=this.ctx.createGain();h.type="triangle",h.frequency.value=180,l.gain.setValueAtTime(.1,i),l.gain.exponentialRampToValueAtTime(.01,i+.08),h.connect(l),l.connect(this.musicGain),h.start(i),h.stop(i+.1)}const s=this.createNoise(.03),n=this.ctx.createGain(),a=this.ctx.createBiquadFilter();a.type="highpass",a.frequency.value=8e3,n.gain.setValueAtTime(t%2===0?.08:.04,i),n.gain.exponentialRampToValueAtTime(.01,i+.03),s.connect(a),a.connect(n),n.connect(this.musicGain),t=(t+1)%16,setTimeout(e,250)};setTimeout(e,1e3)}stop(){this.arpInterval&&clearInterval(this.arpInterval),this.ctx&&(this.ctx.close(),this.ctx=null),this.isStarted=!1}}const X=`#version 300 es
...
`;class N{constructor(t){this.canvas=t;const e=t.getContext("webgl2");if(!e)throw new Error("WebGL2 не поддерживается");this.gl=e,this.uniforms={resolution:null,time:null,cameraPos:null,cameraDir:null,cameraYaw:null,cameraPitch:null,targets:null,targetCount:null,muzzleFlash:null,pools:null,poolCount:null,acidProjectiles:null,acidProjectileCount:null,acidRainZones:null,acidRainZoneCount:null,era:null,wave:null,greenBossPhase2:null,pickups:null,pickupCount:null,crystals:null,crystalCount:null},this.init()}gl;program=null;uniforms;vao=null;renderScale=.75;init(){const t=this.gl,e=this.compileShader(t.VERTEX_SHADER,X),i=this.compileShader(t.FRAGMENT_SHADER,j);if(!e||!i)throw new Error("Ошибка компиляции шейдеров");if(this.program=t.createProgram(),t.attachShader(this.program,e),t.attachShader(this.program,i),t.linkProgram(this.program),!t.getProgramParameter(this.program,t.LINK_STATUS))throw new Error("Ошибка линковки: "+t.getProgramInfoLog(this.program));this.uniforms.resolution=t.getUniformLocation(this.program,"u_resolution"),this.uniforms.time=t.getUniformLocation(this.program,"u_time"),this.uniforms.cameraPos=t.getUniformLocation(this.program,"u_cameraPos"),this.uniforms.cameraYaw=t.getUniformLocation(this.program,"u_cameraYaw"),this.uniforms.cameraPitch=t.getUniformLocation(this.program,"u_cameraPitch"),this.uniforms.targets=t.getUniformLocation(this.program,"u_targets"),this.uniforms.targetCount=t.getUniformLocation(this.program,"u_targetCount"),this.uniforms.muzzleFlash=t.getUniformLocation(this.program,"u_muzzleFlash"),this.uniforms.pools=t.getUniformLocation(this.program,"u_pools"),this.uniforms.poolCount=t.getUniformLocation(this.program,"u_poolCount"),this.uniforms.acidProjectiles=t.getUniformLocation(this.program,"u_acidProjectiles"),this.uniforms.acidProjectileCount=t.getUniformLocation(this.program,"u_acidProjectileCount"),this.uniforms.acidRainZones=t.getUniformLocation(this.program,"u_acidRainZones"),this.uniforms.acidRainZoneCount=t.getUniformLocation(this.program,"u_acidRainZoneCount"),this.uniforms.era=t.getUniformLocation(this.program,"u_era"),this.uniforms.wave=t.getUniformLocation(this.program,"u_wave"),this.uniforms.greenBossPhase2=t.getUniformLocation(this.program,"u_greenBossPhase2"),this.uniforms.pickups=t.getUniformLocation(this.program,"u_pickups"),this.uniforms.pickupCount=t.getUniformLocation(this.program,"u_pickupCount"),this.uniforms.crystals=t.getUniformLocation(this.program,"u_crystals"),this.createQuad()}compileShader(t,e){const i=this.gl,s=i.createShader(t);return s?(i.shaderSource(s,e),i.compileShader(s),i.getShaderParameter(s,i.COMPILE_STATUS)?s:(console.error("Ошибка шейдера:",i.getShaderInfoLog(s)),i.deleteShader(s),null)):null}createQuad(){const t=this.gl,e=new Float32Array([-1,-1,1,-1,-1,1,1,1]);this.vao=t.createVertexArray(),t.bindVertexArray(this.vao);const i=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,i),t.bufferData(t.ARRAY_BUFFER,e,t.STATIC_DRAW);const s=t.getAttribLocation(this.program,"a_position");t.enableVertexAttribArray(s),t.vertexAttribPointer(s,2,t.FLOAT,!1,0,0),t.bindVertexArray(null)}resize(){const t=window.devicePixelRatio||1,e=Math.floor(this.canvas.clientWidth*t*this.renderScale),i=Math.floor(this.canvas.clientHeight*t*this.renderScale);(this.canvas.width!==e||this.canvas.height!==i)&&(this.canvas.width=e,this.canvas.height=i,this.gl.viewport(0,0,e,i))}render(t,e,i,s,n,a,o,r,c,h,l,u,p,m,f,d,y,v,b){const g=this.gl;this.resize(),g.useProgram(this.program),g.bindVertexArray(this.vao),g.uniform2f(this.uniforms.resolution,this.canvas.width,this.canvas.height),g.uniform1f(this.uniforms.time,t),g.uniform3f(this.uniforms.cameraPos,e.x,e.y,e.z),g.uniform1f(this.uniforms.cameraYaw,i),g.uniform1f(this.uniforms.cameraPitch,s),g.uniform4fv(this.uniforms.targets,n),g.uniform1i(this.uniforms.targetCount,a),g.uniform1f(this.uniforms.muzzleFlash,o),r&&c!==void 0?(g.uniform4fv(this.uniforms.pools,r),g.uniform1i(this.uniforms.poolCount,c)):g.uniform1i(this.uniforms.poolCount,0),f&&d!==void 0&&d>0?(g.uniform4fv(this.uniforms.acidProjectiles,f),g.uniform1i(this.uniforms.acidProjectileCount,d)):g.uniform1i(this.uniforms.acidProjectileCount,0),y&&v!==void 0&&v>0?(g.uniform4fv(this.uniforms.acidRainZones,y),g.uniform1i(this.uniforms.acidRainZoneCount,v)):g.uniform1i(this.uniforms.acidRainZoneCount,0),g.uniform1i(this.uniforms.era,h||1),g.uniform1i(this.uniforms.wave,l||1),g.uniform1i(this.uniforms.greenBossPhase2,b?1:0),u&&p!==void 0?(g.uniform4fv(this.uniforms.pickups,u),g.uniform1i(this.uniforms.pickupCount,p)):g.uniform1i(this.uniforms.pickupCount,0),m&&g.uniform4fv(this.uniforms.crystals,m),g.drawArrays(g.TRIANGLE_STRIP,0,4)}destroy(){this.program&&this.gl.deleteProgram(this.program)}}class U{healthEl;ammoEl;fragsEl;crosshairEl;hitmarkerEl;reloadEl;waveEl;messageEl;damageOverlay;weaponEl;constructor(){this.healthEl=document.getElementById("health-value"),this.ammoEl=document.getElementById("ammo-value"),this.fragsEl=document.getElementById("frags-value"),this.crosshairEl=document.getElementById("crosshair"),this.hitmarkerEl=document.getElementById("hitmarker"),this.reloadEl=document.getElementById("reload-indicator"),this.reloadEl&&(this.reloadEl.style.display="none"),this.waveEl=this.createWaveElement(),this.messageEl=this.createMessageElement(),this.damageOverlay=this.createDamageOverlay(),this.weaponEl=this.createWeaponElement()}createWaveElement(){let t=document.getElementById("wave-indicator");return t||(t=document.createElement("div"),t.id="wave-indicator",t.style.cssText=`
        ...
        z-index: 1000;
        letter-spacing: 4px;
      `,["top-left","top-right","bottom-left","bottom-right"].forEach(i=>{const s=document.createElement("div"),[n,a]=i.split("-");s.style.cssText=`
          position: absolute;
          ${n}: -2px;
          ${a}: -2px;
          width: 12px;
          height: 12px;
          border-${n}: 2px solid #00ffff;
    ...
    `,i.textContent=t,document.body.appendChild(i),!document.getElementById("message-anim-style")){const s=document.createElement("style");s.id="message-anim-style",s.textContent=`
      ...
      `,this.bossHealthFill=document.createElement("div"),this.bossHealthFill.style.cssText=`
        ...
        border-radius: 10px;
      `,a.appendChild(this.bossHealthFill),this.bossHealthBar.appendChild(a),document.body.appendChild(this.bossHealthBar)}let s="БОСС",n="#ff0000";if(i==="boss_green"?(s="☠️ ТОКСИЧНЫЙ ГИГАНТ ☠️",n="linear-gradient(90deg, #00ff00, #88ff00)",this.bossHealthBar.style.borderColor="#00ff00",this.bossHealthBar.style.boxShadow="0 0 20px rgba(0, 255, 0, 0.5)"):i==="boss_black"?(s="🌀 ВЛАДЫКА ПУСТОТЫ 🌀",n="linear-gradient(90deg, #4400aa, #8800ff)",this.bossHealthBar.style.borderColor="#8800ff",this.bossHealthBar.style.boxShadow="0 0 20px rgba(136, 0, 255, 0.5)"):i==="boss_blue"&&(s="⚡ ФАНТОМ ХАОСА ⚡",n="linear-gradient(90deg, #0088ff, #00ffff)",this.bossHealthBar.style.borderColor="#00ffff",this.bossHealthBar.style.boxShadow="0 0 20px rgba(0, 255, 255, 0.5)"),this.bossNameEl&&(this.bossNameEl.textContent=s),this.bossHealthFill){const a=t/e*100;this.bossHealthFill.style.width=a+"%",this.bossHealthFill.style.background=n}this.bossHealthBar.style.display="block"}hideBossHealth(){this.bossHealthBar&&(this.bossHealthBar.style.display="none")}showBossIntro(t,e){let i="БОСС",s="",n="#ff0044",a="rgba(255, 0, 68, 0.5)",o="💀";t==="boss_green"?(i="ЯДОВИТЫЕ БЛИЗНЕЦЫ",s="Охотник & Загонщик",n="#00ff44",a="rgba(0, 255, 68, 0.5)",o="☣️"):t==="boss_black"?(i="ВЛАДЫКА ПУСТОТЫ",s="Повелитель Тьмы",n="#8800ff",a="rgba(136, 0, 255, 0.5)",o="🌀"):t==="boss_blue"&&(i="ФАНТОМ ХАОСА",s="Владыка Молний",n="#00ffff",a="rgba(0, 255, 255, 0.5)",o="⚡");const r=document.createElement("div");r.id="boss-intro-overlay",r.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
    ...
    `,c.textContent=o;const h=document.createElement("div");h.style.cssText=`
      font-family: 'Orbitron', sans-serif;
      font-size: 72px;
      font-weight: 900;
      color: ${n};
